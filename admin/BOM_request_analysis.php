...
/**
 * admin/BOM_request_analysis.php
 * Part of: Admin module
 * Filename suggests: BOM request analysis
 *
 ...
 <div id="content-header">
  ...
  <div class="container-fluid">
    ...
    <!--  <div class="span12">-->
     ...
     <form name="frmSearch" method="get" action="BOM_request_analysis2.php">
   ...
   $query8 = "SELECT COUNT(*) FROM mat_master_detail";
...
$query = "SELECT * FROM mat_master_detail ORDER BY material ASC";
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_BOM_request_download.php"><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
     <td width="7%">&nbsp;</td>
