...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM mat_master_detail WHERE (material LIKE '%".$_GET["txtKeyword"]."%' or bill_component LIKE '%".$_GET["txtKeyword"]."%' )";
...
$query = "SELECT * FROM mat_master_detail WHERE (material LIKE '%".$_GET["txtKeyword"]."%' or bill_component LIKE '%".$_GET["txtKeyword"]."%' ) ORDER BY material ASC";
