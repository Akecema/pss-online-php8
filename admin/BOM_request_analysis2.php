...
/**
 * admin/BOM_request_analysis2.php
 * Part of: Admin module
 * Filename suggests: BOM request analysis2
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, sys_setup_maintain, mat_master_detail.
...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
        ...
        <!--<div class="widget-box">
          ...
          <div class="widget-title">
            <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="BOM_request_analysis.php">BOM Download</a></li>
            </ul>
          </div>
          </div>
   ...
   $query8 = "SELECT COUNT(*) FROM mat_master_detail WHERE (material LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' or bill_component LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' )";
...
$query = "SELECT * FROM mat_master_detail WHERE (material LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' or bill_component LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' ) ORDER BY material ASC";
