...
/**
 * admin/FG_request_analysis.php
 * Part of: Admin module
 * Filename suggests: FG request analysis
 *
 ...
 <div id="content-header">
  ...
  <div class="container-fluid">
    ...
    <!--  <div class="span12">-->
     ...
     <form name="frmSearch" method="get" action="FG_request_analysis2.php">
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_FG_request_download.php"><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
     <td width="7%">&nbsp;</td>
