...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_FG_request_download_search.php?txtKeyword=<?php echo $_GET["txtKeyword"]; ?>"><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
     <td width="7%">&nbsp;</td>
