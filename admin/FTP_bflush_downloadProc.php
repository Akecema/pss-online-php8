...
/**
 * admin/FTP_bflush_downloadProc.php
 * Part of: Admin module
 * Filename suggests: FTP bflush downloadProc
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, sys_setup_maintain, ftp_bflush_detail.
...
<div id="content">
 <div id="content-header" class="noprint">
  <div id="breadcrumb"> <a href="index_admin.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">FTP Monitoring</a> <a href="#" class="current">Backflush Details</a> </div>
  <h1>Backflush</h1>
</div>
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
       <td width="7%"><a href="report_FTP_backflush_downloadProc.php?date1=<?php echo h($dateF); ?>&&date2=<?php echo h($dateT); ?>"><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
