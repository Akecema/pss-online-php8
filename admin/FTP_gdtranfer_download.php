...
/**
 * admin/FTP_gdtranfer_download.php
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_admin.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">FTP Monitoring</a> <a href="#" class="current">Good Tranfer Details</a> </div>
  <h1>Good Tranfer </h1>
</div>
