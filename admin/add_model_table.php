...
$query_db = "INSERT INTO model_detail(code_model,model_name,model_desc,comp_code) VALUES('','".strtoupper($model_name)."',?,'".strtoupper($comp_code)."')"; $query_db_args = [$model_desc];
