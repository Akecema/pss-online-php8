...
/**
 * admin/add_tbl_storage_QC.php
 * Part of: Admin module
 * Filename suggests: add tbl storage QC
 *
...
{ 
	$slocCD = escape_data($_POST['qc_sloc_code']);
}
...
{ 
	$slocDC = escape_data($_POST['qc_sloc_desc']);
}
...
if($slocCD && $slocDC) //everything ok
{
	...
	$query_db = "INSERT INTO storage2_tbl(qc_sloc_code,qc_sloc_desc) VALUES(?,?)"; $query_db_args = [$slocCD, $slocDC];
  ...
  <!--  <div class="span6">-->
          ...
          <div class="widget-title">
            <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              <li class="active"><a role="tab" href="add_tbl_storage_QC.php">QC Storage Location </a></li>
              <li><a role="tab" href="storage_QC_list.php">QC Storage Location List</a></li>
            </ul>
          </div>
          </div>
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5><a role="tab" href="add_tbl_storage_PD.php">QC </a>Storage Location</h5></div>
       ...
       <!--    <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
               <input name="qc_sloc_code" type="text" class="span11" id="sloc_code" size="55" maxlength="20" value="<?php if(isset($_POST['qc_sloc_code'])) echo h($_POST['qc_sloc_code']); ?>"  placeholder="Enter Storage Location " />
            </div>
            </div>
            <div class="control-group">
              <label class="control-label">Storage Location : <font color="#FF0000"><b> *</b></font></label>
              <div class="controls">
                <input name="qc_sloc_desc" type="text" class="span11" id="sloc_desc" size="55" maxlength="20" value="<?php if(isset($_POST['qc_sloc_desc'])) echo h($_POST['qc_sloc_desc']); ?>"  placeholder="Enter Storage Location Description" />
              </div>
            </div>
            <div class="control-group">
