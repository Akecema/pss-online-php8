...
$query_db = "INSERT INTO vendor_detail(vendor_code,vendor_name,add_no1,add_no2,post_code,post_city,post_region,post_country,search_term,tphone,fax_no,payment_method,term_payment,user_create,date_create,user_update,date_update,status_acc,status_subcont) VALUES('".strtoupper($vendor_code)."','".strtoupper($vendor_name)."',?,?,?,?,?,?,'".strtoupper($search_term)."',?,?,'".strtoupper($payment_method)."','".strtoupper($term_payment)."',?,NOW(),'','',?,?)"; $query_db_args = [$add_no1, $add_no2, $post_code, $post_city, $post_region, $post_country, $tphone, $fax_no, $username, $status_acc, $status_subcont];
