...
/**
 * admin/bom_header_upload.php
 * Part of: Admin module
 * Filename suggests: bom header upload
 *
  ...
  <!--  <div class="span6">-->
          ...
          <div class="widget-title">
            <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              <li class="active"><a  role="tab" href="bom_header_upload.php">FG/SFG</a></li>
...
<td width="50%" style="font:bold 12px tahoma, arial, sans-serif; text-align:right; border-bottom:1px solid #eee; padding:5px 10px 5px 0px; border-right:1px solid #eee;">Select file FG or Semi-FG</td>
...
if($uploadedStatus == 1){
	...
	echo "<script>";
   echo "window.location='bom_header_uploadProc.php?file=".rawurlencode($storagename)."';";
   echo "</script>";
