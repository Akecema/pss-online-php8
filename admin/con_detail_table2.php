      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title">
           ...
           <?php
$query8 = "SELECT COUNT(*) FROM consumable_detail WHERE (material_no LIKE ?) or (mat_desc LIKE ?)"; $query8_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
...
$query = "SELECT * FROM consumable_detail WHERE (material_no LIKE ?) or (mat_desc LIKE ?) ORDER BY id_con ASC"; $query_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
