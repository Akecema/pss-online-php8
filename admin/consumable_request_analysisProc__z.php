...
/**
 * admin/consumable_request_analysisProc__z.php
 * Part of: Admin module
 * Filename suggests: consumable request analysisProc z
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, factory_detail, consumable_detail, consumable_request, post_consumable_detail_header.
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_admin.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Consumable Request</a> <a href="#" class="current">Consumable Request Analysis</a> </div>
    ...
    <!--  <div class="span12">-->
       ...
       <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" name="frmSearch" id="frmSearch">
         <table class="table table-bordered table-striped">
            <tr>
                  <th>Factory :</th>
                  <td colspan="3">  <select name="factory" id="factory" class="span5">
                ...
                <tr>
              <th>Material No.  :</th>
              <td  colspan="3"><select name="material_no" id="material_no" class="span5">
