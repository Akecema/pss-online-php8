...
/**
 * admin/detail_material_request_history.php
...
?></tbody>
  ...
  <tr>
    ...
    <th height="30" valign="top">
      <p><?php echo h($row_reason_tbl["reason_desc_cancel"]).' - ' . h($row_display_reason["reason_cancel2"]); ?></p></th>
  </tr> 
</table>
<?php
  }
  ...
  <tr>
    ...
    <th width="4%">:</th>
    <th height="30" valign="top">
      <p><?php echo h($row_reason_tbl2["reason_desc"]).' - ' . h($row_display_reason2["reason_close2"]); ?></p></th>
  </tr>
</table>
	<?php
      }
