...
<div id="content">
 ...
 $query8 = "SELECT COUNT(*) FROM model_detail WHERE (model_name LIKE ?) or (model_desc LIKE ?) or (comp_code LIKE ?)"; $query8_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
...
$query = "SELECT * FROM model_detail  WHERE (model_name LIKE ?) or (model_desc LIKE ?)  or (comp_code LIKE ?) ORDER BY model_name ASC"; $query_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
