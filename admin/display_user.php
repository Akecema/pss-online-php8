...
/**
 * admin/display_user.php
 * Part of: Admin module
 * Filename suggests: display user
 *
 * Behavior: requires an active login session ($_SESSION['username']).
 * Database tables referenced: user_detail, sys_setup_maintain, level_detail.
 ...
 <div id="content-header">
  ...
  <div class="container-fluid">
    ...
    <!--  <div class="span12">-->
        ...
        <form name="frmSearch" method="get" action="display_user2.php">
