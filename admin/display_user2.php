...
$query8 = "SELECT COUNT(*) FROM user_detail where (staff_ID LIKE ? or user_fullname LIKE ? ) ORDER BY user_no ASC"; $query8_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
...
?>
  ...
  $row4_p = mysqli_fetch_array($result4_p);
      ...
      ?>
                ...
                <td width="96" height="28"><?php echo h($row[2]); ?></td>
                <!--<td width="124" height="28"><?php  echo h($row4_p["desc_level"]); ?></td>-->
                <td width="140"><font color="#FF0000"><?php echo $sts; ?></font></td>
                <td width="100"><a value="Details" href="detail_user.php?user_no=<?php echo h($user_no); ?>&&TB_iframe=true&height=400&width=650" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
                <td width="100">&nbsp;<a value="Edit" href="user_edit.php?user_no=<?php echo h($user_no); ?>&&TB_iframe=true&height=400&width=650" class="thickbox" target="_self"> <img src="../img/edit.gif" width="16" height="16" alt="Edit">Edit</a></td>
                 <?php
				 if($row[20] == "Y")
	  {
				?>
                 <td width="100">&nbsp; <a value="Unlock Password" href="unlock_pass_account.php?user_no=<?php echo h($user_no); ?>&&TB_iframe=true&height=400&width=650" class="thickbox" target="_self"> <img src="../img/lock3.png" width="20" height="20" alt="Unlock Password">Unlock</a></td>
                 <?php
	  }else{
	  ...
	  ?>
                 ...
                 <input name="user_no" type="hidden" value="<?php echo h($user_no); ?>">
          <?php 
