...
$queryu = "SELECT * FROM model_detail WHERE code_model = ?"; $queryu_args = [$code_model];
...
{     	
		  	  $query_search = "SELECT * FROM model_detail WHERE code_model = ?"; $query_search_args = [$code_model];
		...
		$query_upd = "UPDATE model_detail SET model_desc = ?, comp_code = '".strtoupper($comp_code)."' WHERE code_model = ?"; $query_upd_args = [$model_desc, $code_model]; 
          ...
          <form name="form1" method="post" action="mat_model_edit.php?code_model=<?php echo h($code_model); ?>" >
              <table class="table table-bordered">
               <tr>
                 ...
                 <td>:</td>
                 <td>
                   <input name="model_name" type="text" id="model_name" size="20" maxlength="8" readonly value="<?php echo h($row[1]); ?>" /></td>
               </tr>
               <tr>
                 <td>Reason Reject Desc *</td>
                 <td>:</td>
                 <td>
                   <input name="model_desc" type="text" class="span11" id="model_desc" size="55" maxlength="100" value="<?php echo h($row[2]); ?>" />
               </td>
               </tr>
                 <tr>
                 <td>Company*</td>
                 <td>:</td>
                 <td>
                   <input name="comp_code" type="text" class="span11" id="comp_code" size="55" maxlength="100" value="<?php echo h($row[3]); ?>" />
                </td>
                </tr>
                 <tr>
                 <td>&nbsp;</td>
