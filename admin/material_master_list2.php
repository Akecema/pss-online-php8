...
/**
 * admin/material_master_list2.php
...
$query = "SELECT * FROM mat_master_header WHERE (material_no LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' or bom LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' ) ORDER BY material_no ASC $pages->limit";
