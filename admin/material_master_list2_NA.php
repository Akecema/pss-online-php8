...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM mat_master_header WHERE status_BOM = 'N' AND (material_no LIKE '%".$_GET["txtKeyword"]."%' or bom LIKE '%".$_GET["txtKeyword"]."%' )";
...
$query = "SELECT * FROM mat_master_header WHERE status_BOM = 'N' AND (material_no LIKE '%".$_GET["txtKeyword"]."%' or bom LIKE '%".$_GET["txtKeyword"]."%' ) ORDER BY material_no ASC $pages->limit";
