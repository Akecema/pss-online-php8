...
/**
 * admin/material_master_list2_NA.php
 * Part of: Admin module
 * Filename suggests: material master list2 NA
 *
...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM mat_master_header WHERE status_BOM = 'N' AND (material_no LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' or bom LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' )";
...
$query = "SELECT * FROM mat_master_header WHERE status_BOM = 'N' AND (material_no LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' or bom LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' ) ORDER BY material_no ASC $pages->limit";
