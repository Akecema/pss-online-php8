...
/**
 * admin/material_master_list_NA.php
 * Part of: Admin module
 * Filename suggests: material master list NA
 *
...
?>
   ...
   while ($row2 = mysqli_fetch_array($rs))
   {
      ...
      ?>
                ...
                <td><a value="Details" href="material_master_view.php?id_hdr=<?php echo h($row2["id_hdr"]); ?>&amp;&amp;TB_iframe=true&amp;height=500&amp;width=800" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View" />View</a></td>
                <td>&nbsp; <a value="Edit" href="material_master_edit_NA.php?id_hdr=<?php echo h($row2["id_hdr"]); ?>&amp;&amp;TB_iframe=true&amp;height=700&amp;width=700" class="thickbox" target="_self"> <img src="../img/edit.gif" width="16" height="16" alt="Edit" />Edit</a></td>
                </tr>
