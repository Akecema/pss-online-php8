...
/**
 * admin/material_master_upload.php
 * Part of: Admin module
 * Filename suggests: material master upload
 *
  ...
  <!--  <div class="span6">-->
          ...
          <div class="widget-title">
            <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="material_master_upload.php">Material Master Upload</a></li>
              <li><a role="tab" href="material_component_upload.php">Material Component Upload</a></li>
              <!--<li><a role="tab" href="upd_mat_upload.php">update mat desc</a></li>-->
            </ul>
          </div>
          </div>
...
<td width="50%" style="font:bold 12px tahoma, arial, sans-serif; text-align:right; border-bottom:1px solid #eee; padding:5px 10px 5px 0px; border-right:1px solid #eee;">Select material master</td>
...
{
	echo "<script>";
	echo "window.location='material_master_uploadProc.php?file=".rawurlencode($storagename)."';";
	echo "</script>";
