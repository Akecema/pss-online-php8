...
/**
 * admin/posting_request_all_screen_LCD_WIP.php
 ...
 * Includes: config.php, paginator.class2.php, tc_calendar.php, content3.php, top_modal_menu.php, left_admin_menu.php, footer.php.
 *
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_admin.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Board</a> <a href="#" class="current">WIP Request Board</a> </div>
  <h1>Board</h1>
</div>
