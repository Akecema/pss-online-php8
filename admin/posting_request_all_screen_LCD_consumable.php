...
/**
 * admin/posting_request_all_screen_LCD_consumable.php
 ...
 * Includes: config.php, paginator.class2.php, tc_calendar.php, content2.php, top_modal_menu.php, left_admin_menu.php, td>
           <td><?php echo $data_u[, ]..
 *
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_admin.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Board</a> <a href="#" class="current">Consumable Request Board</a> </div>
  <h1>Board</h1>
</div>
...
$query = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR, consumable_detail AS SD WHERE MR.id_con = SD.id_con AND MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status  != 'Cancel') GROUP BY MR.temp_mrin, MR.id_work ORDER BY MR.date_require, MR.time_require DESC ";
        ...
        if($result_upd3 || $result_upd4)
		 {
		   ...
		   $result_upd8 = db_query_bind($dbc, $query_upd8, $query_upd8_args) or trigger_error("SQL", E_USER_ERROR);
