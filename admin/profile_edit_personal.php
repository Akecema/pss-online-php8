...
/**
 * admin/profile_edit_personal.php
...
{  
			  ...
			  //echo $num_search; 
				...
				$query_upd = "UPDATE user_detail SET user_fullname=?, department = ?, designation = ?, company = ?, user_telno1=?, user_telno2=?, user_fax=?, user_email=?, 
							  date_update= NOW(), user_update =? WHERE user_no = ?"; $query_upd_args = [$user_fullname, $department, $designation, $company, $user_telno1, $user_telno2, $user_fax, $user_email, $username, $user_no];
...
{ echo '<div class="msg msg-error"><font color="red" class ="error_entry">', $message, '</font></div>';
 ...
 ?> 
        ...
        <div class="box">
            ...
            <h2><img src="../img/edit_icon.png" width="24" height="24"/>Edit Account</h2>
