          ...
          <form name="form1" method="post" action="reason_wastage_edit.php?id_reason_wastage=<?php echo $id_reason_wastage; ?>" >
              <table class="table table-bordered">
               <tr>
                 ...
                 <td>:</td>
                 <td>
                   <input name="id_reason_wastage" type="text" id="id_reason_wastage" size="20" maxlength="8" readonly value="<?php echo $row[0]; ?>" /></td>
               </tr>
               <tr>
                 <td>Reason Wastage Desc *</td>
                 <td>:</td>
                 <td>
                   <input name="reason_wastage_desc" type="text" class="span11" id="reason_wastage_desc" size="55" maxlength="100" value="<?php echo $row[1]; ?>" />
               </td>
               </tr>
                        <tr>
                 <td>Status *</td>
