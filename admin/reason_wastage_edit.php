...
$queryu = "SELECT * FROM reason_wastage WHERE id_reason_wastage = ?"; $queryu_args = [$id_reason_wastage];
...
{     	
		  	  $query_search = "SELECT * FROM reason_wastage WHERE id_reason_wastage = ?"; $query_search_args = [$id_reason_wastage];
		...
		$query_upd = "UPDATE reason_wastage SET reason_wastage_desc = ?, status_reason_wastage = ? WHERE id_reason_wastage = ?"; $query_upd_args = [$reason_wastage_desc, $status_reason_wastage, $id_reason_wastage]; 
...
{ echo '<div class="msg msg-error"><font color="red" class ="error_entry">', $message, '</font></div>';
 ...
 ?> 
          ...
          <!-- End Box Head -->
          <form name="form1" method="post" action="reason_wastage_edit.php?id_reason_wastage=<?php echo h($id_reason_wastage); ?>" >
