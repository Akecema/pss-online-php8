...
/**
 * admin/reason_wastage_table.php
 * Part of: Admin module
 * Filename suggests: reason wastage table
 *
...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
    ...
    <!--  <div class="span12">-->
      ...
      <form name="frmSearch" method="get" action="reason_wastage_table2.php">
 ...
 $query8 = "SELECT COUNT(*) FROM reason_wastage";
...
$query = "SELECT * FROM reason_wastage ORDER BY id_reason_wastage ASC";
