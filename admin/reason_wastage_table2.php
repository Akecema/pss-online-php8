...
<div id="content">
 ...
 $query8 = "SELECT COUNT(*) FROM reason_wastage WHERE (id_reason_wastage LIKE ?) or (reason_wastage_desc LIKE ?)"; $query8_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
...
$query = "SELECT * FROM reason_wastage WHERE (id_reason_wastage LIKE ?) or (reason_wastage_desc LIKE ?) ORDER BY id_reason_wastage ASC"; $query_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
...
?>
    ...
    while ($row2 = mysqli_fetch_array($rs))
   {
      ...
      ?>
                ...
                <tr class="gradeX">
                <td><div align="center"><?php  echo h($row2["id_reason_wastage"]); ?></div></td>
                <td>&nbsp;<?php  echo h($row2["reason_wastage_desc"]); ?></td>
                <td>&nbsp;<?php  echo h($row2["status_reason_wastage"]); ?></td>
                <td><div align="center"><a value="Details" href="reason_wastage_view.php?id_reason_wastage=<?php echo h($row2["id_reason_wastage"]); ?>&amp;&amp;TB_iframe=true&amp;height=400&amp;width=700" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View" />View</a></div></td>
                <td>&nbsp; <a value="Edit" href="reason_wastage_edit.php?id_reason_wastage=<?php echo h($row2["id_reason_wastage"]); ?>&amp;&amp;TB_iframe=true&amp;height=400&amp;width=700" class="thickbox" target="_self"> <img src="../img/edit.gif" width="16" height="16" alt="Edit" />Edit</a></td>             
                </tr>
