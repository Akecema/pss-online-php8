...
<div id="content">
 ...
 $query8 = "SELECT COUNT(*) FROM reason_wastage WHERE (id_reason_wastage LIKE '%".$_GET["txtKeyword"]."%') or (reason_wastage_desc LIKE '%".$_GET["txtKeyword"]."%')";
...
$query = "SELECT * FROM reason_wastage WHERE (id_reason_wastage LIKE '%".$_GET["txtKeyword"]."%') or (reason_wastage_desc LIKE '%".$_GET["txtKeyword"]."%') ORDER BY id_reason_wastage ASC";
