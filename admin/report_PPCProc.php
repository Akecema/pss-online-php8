...
/**
 * admin/report_PPCProc.php
 * Part of: Admin module
 * Filename suggests: report PPCProc
 *
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_admin.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Material Request</a> <a href="#" class="current">Material Request Report</a> </div>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" name="frmSearch" id="frmSearch">
         <table class="table table-bordered table-striped">
	       ...
	       $query3 = "SELECT * FROM factory_detail GROUP BY factory_desc2 ORDER BY id_fac ASC";
              ...
              <th><div align="right">Work Center :</div></th>
            ...
            <tr>
              ...
              <th>&nbsp;</th>
              <th>&nbsp;</th>
              <th><input name="Submit2" type="submit" value="Search" class="btn btn-info"></th>
            </tr>
           </table>
        </form>
   ...
   $query8 = "SELECT *,DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM material_request AS MR, scan_detail AS SD WHERE MR.id_scan = SD.id_scan AND MR.status_request = 'Y' AND MR.status != 'Cancel' " .$where_sql."GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC,MR.temp_mrin ASC";
...
$query = "SELECT *,DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM material_request AS MR, scan_detail AS SD WHERE MR.id_scan = SD.id_scan AND MR.status_request = 'Y' AND MR.status != 'Cancel' ".$where_sql."GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC,MR.temp_mrin ASC";
...
$date_post =  ($row2["date_posting"].' '.$row2["time_posting"]);
...
$since_start = $start_date->diff(new DateTime($date_transfer));
  ...
  <tr>
    ...
    <td><?php echo h($row_scan["factory"]); ?></td>
    ...
    <td><a value="Details" href="detail_material_request_history.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&prod_order=<?php echo h($row2["prod_order"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
   <td><a href="detail_material_request_history_printing.php?mrin_no=<?php echo h($row["temp_mrin"]); ?>&&prod_order=<?php echo h($row2["prod_order"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>
  <?php 
