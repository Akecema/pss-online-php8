...
/**
 * admin/report_PPCProc_consumable.php
 ...
 * Includes: config.php, paginator.class2.php, tc_calendar.php, top_modal_menu.php, left_admin_menu.php, ]., ]);
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_admin.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Consumable Request</a> <a href="#" class="current">Consumable Request Report</a> </div>
...
?></td>
   ...
   $query8 = "SELECT *,DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM consumable_request AS MR WHERE MR.status_request = 'Y' AND MR.status != 'Cancel'" .$where_sql." GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC,MR.temp_mrin ASC"; $query8_args = [...$where_args];
...
$query = "SELECT *,DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM consumable_request AS MR WHERE MR.status_request = 'Y' AND MR.status != 'Cancel'".$where_sql." GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC,MR.temp_mrin ASC"; $query_args = [...$where_args];
...
<br>
 <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Material Request Analysis</h5>
          </div>
      ...
      <tr>
                ...
                <th width="100" height="28" bgcolor="#E9F58D"><span class="style3">Request Date</span></th>
                <th width="100" height="28" bgcolor="#E9F58D" class="ac style3"><div align="right">Request Time</div></th>
                <th width="134" bgcolor="#E9F58D" class="ac style3">Requestor</th>
            <th width="48" bgcolor="#E9F58D" class="ac style3">View</th>
                <th width="55" bgcolor="#E9F58D" class="ac style3">Print</th>
          </tr>
          </thead><tbody>
   ...
   while ($row2 = mysqli_fetch_array($rs))
   {
	...
	$query_again = "SELECT * FROM consumable_request WHERE status_request = 'Y' and id_scan = ? ORDER BY id_req_con ASC"; $query_again_args = [$row2[5]];
	...
	$data_u = mysqli_fetch_array($result_u);   //how many records are there?    
 	...
 	$query3 = "SELECT * FROM factory_detail WHERE id_fac = ?"; $query3_args = [$row["factory"]];
...
$since_start = $start_date->diff(new DateTime($date_transfer));
  ...
  <tr>
    <td width="143">&nbsp;<?php echo h($row["temp_mrin"]); ?></td>
    <td width="50"><div align="center"><?php echo h($row["factory"]); ?></div></td>
     <td width="50" height="28"><div align="center"><?php echo h($row2["id_work"]); ?></div></td>
              <td width="100"><div align="center"><?php echo h($row2["R"]); ?></div></td>
              <td width="100"><div align="center"><?php echo h($row2["time_require"]); ?></div></td>
            <td width="134"><?php echo h($data_u["user_fullname"]); ?></td>
       
              <td width="48"><a value="Details" href="detail_consumable_request.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
                <td width="55"><a href="detail_consumable_request_printing.php?mrin_no=<?php echo h($row["temp_mrin"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr> 
  <?php 
