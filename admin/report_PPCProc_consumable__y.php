...
/**
 * admin/report_PPCProc_consumable__y.php
 * Part of: Admin module
 * Filename suggests: report PPCProc consumable y
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, factory_detail, consumable_request.
