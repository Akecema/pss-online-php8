...
/**
 * admin/report_PPC_bstrap_calendar.php
 * Part of: Admin module
 * Filename suggests: report PPC bstrap calendar
 *
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="frmSearch" id="frmSearch">
		...
		<div class="form-group">
               <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input class="form-control" size="10" type="text" value="" readonly placeholder="Select Date">
...
?></td>
        ...
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
            echo "window.location='report_PPCProc.php?temp_mrin=$temp_mrin&&prod_order=$prod_order&&date1=$dateF&&date2=$dateT&&work_center=$work_center&&factory=$factory'";
            echo "</script>";
...
<!--calendar picker -part-->
<script type="text/javascript" src="../bootstrap-datetimepicker-master/jquery/jquery-1.8.3.min.js" charset="UTF-8"></script>
<script type="text/javascript" src="../bootstrap-datetimepicker-master/bootstrap/js/bootstrap.min.js"></script>
