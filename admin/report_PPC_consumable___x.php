...
/**
 * admin/report_PPC_consumable___x.php
 * Part of: Admin module
 * Filename suggests: report PPC consumable x
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, factory_detail.
...
?></td>
        ...
        <td><input name="temp_mrin" type="text" id="temp_mrin" size="25" class="span11" /> </td>
            ...
            <tr>
              ...
              <td height="25">&nbsp;</td>
              <th height="25">&nbsp;</th>
              <td height="25"><input name="Submit2" type="submit" class="btn btn-info" id="button" value="SEARCH" /></td>
            </tr>
            </table>
        </form>
