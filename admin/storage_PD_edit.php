...
$queryu = "SELECT * FROM storage_tbl WHERE sloc_code = '".db_esc($dbc, $cd)."' ";
...
if (isset($_POST['submit']))
{
	...
	{     	
		...
		$query_search = "SELECT * FROM storage_tbl WHERE sloc_code = '".db_esc($dbc, $cd)."'";
		...
		$query_upd = "UPDATE storage_tbl SET sloc_desc = '".db_esc($dbc, $_POST['sloc_desc'])."' WHERE sloc_code = '".db_esc($dbc, $cd)."' "; 
