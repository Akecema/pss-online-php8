...
/**
 * admin/storage_PD_list.php
 * Part of: Admin module
 * Filename suggests: storage PD list
 *
 ...
 <div id="content-header">
  ...
  <div class="container-fluid">
    ...
    <!--  <div class="span12">-->
      ...
      <form name="frmSearch" method="get" action="storage_PD_list2.php">
...
$query8 = "SELECT COUNT(*) FROM storage_tbl";
...
$query = "SELECT * FROM storage_tbl ORDER BY sloc_code ASC";
...
?>
      ...
      <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5><a role="tab" href="add_tbl_storage_PD.php">Production </a>Storage Location</h5>
          </div>
