...
/**
 * admin/storage_PD_list2.php
 * Part of: Admin module
 * Filename suggests: storage PD list2
 *
...
$query8 = "SELECT COUNT(*) FROM storage_tbl WHERE (sloc_code LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%') or (sloc_desc LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%')";
...
$query = "SELECT * FROM storage_tbl  WHERE (sloc_code LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%') or (sloc_desc LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%') ORDER BY sloc_code ASC";
...
?>
      ...
      <div class="widget-box">
        ...
        ?>
            ...
            <tr class="gradeX">
            <td>&nbsp;<?php  echo h($row2["sloc_code"]); ?></td>
            <td>&nbsp;<?php  echo h($row2["sloc_desc"]); ?></td>
            <td>&nbsp; <a value="Edit" href="storage_PD_edit.php?code=<?php echo h($row2["sloc_code"]); ?>&amp;&amp;TB_iframe=true&amp;height=300&amp;width=700" class="thickbox" target="_self"> <img src="../img/edit.gif" width="16" height="16" alt="Edit" />Edit</a></td>             
            </tr>
