...
$query8 = "SELECT COUNT(*) FROM storage_tbl WHERE (sloc_code LIKE ?) or (sloc_desc LIKE ?)"; $query8_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
...
$query = "SELECT * FROM storage_tbl  WHERE (sloc_code LIKE ?) or (sloc_desc LIKE ?) ORDER BY sloc_code ASC"; $query_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
