...
/**
 * admin/type_wastage_edit.php
 * Part of: Admin module
 * Filename suggests: type wastage edit
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, type_wastage_detail, record.
...
<body>
<div id="content">
  <h4>Edit Type of Wastage</h4> 

    <?php

$id_wastage = $_GET['id_wastage'];

$queryu = "SELECT * FROM type_wastage_detail WHERE id_wastage = ?"; $queryu_args = [$id_wastage];
...
{ $wastage_desc = FALSE;
  $message.= '<p>You are required to enter Type Wastage Description.!</p>';
  }else
...
{     	
		  	  $query_search = "SELECT * FROM type_wastage_detail WHERE id_wastage = ?"; $query_search_args = [$id_wastage];
		...
		$query_upd = "UPDATE type_wastage_detail SET wastage_desc = ?, status_wastage = ? WHERE id_wastage = ?"; $query_upd_args = [$wastage_desc, $status_wastage, $id_wastage]; 
...
{ echo '<div class="msg msg-error"><font color="red" class ="error_entry">', $message, '</font></div>';
 ...
 ?> 
          ...
          <!-- End Box Head -->
          <form name="form1" method="post" action="type_wastage_edit.php?id_wastage=<?php echo h($id_wastage); ?>" >
              <table class="table table-bordered">
               ...
               <tr>
                 ...
                 <td>:</td>
                 <td>
         <select name="status_wastage"  class="textbox">
