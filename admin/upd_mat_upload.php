...
/**
 * admin/upd_mat_upload.php
 * Part of: Admin module
 * Filename suggests: upd mat upload
 *
  ...
  <!--  <div class="span6">-->
          ...
          <div class="widget-title">
            <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="upd_mat_upload.php">update mat desc</a></li>
            </ul>
          </div>
          </div>
...
{
	echo "<script>";
	echo "window.location='upd_mat_uploadProc.php?file=".rawurlencode($storagename)."';";
	echo "</script>";
