...
$query_Ms = "SELECT * FROM mat_master_header as mh WHERE mh.material_type ='Z310' and material_no = ?"; $query_Ms_args = [$col3];
...
if($res_Ms > 0)
{
	$query_upMh = "UPDATE mat_master_header SET material_desc =? WHERE material_no = ? "; $query_upMh_args = [$col4, $col3];
	$result_upMh = db_query_bind($dbc, $query_upMh, $query_upMh_args);
	
	//mm
	$query_upMh2 = "UPDATE table_material SET material_desc =? WHERE material_no = ? "; $query_upMh2_args = [$col4, $col3];
	$result_upMh2 = db_query_bind($dbc, $query_upMh2, $query_upMh2_args);
}
