...
/**
 * admin/work_center_table2.php
 * Part of: Admin module
 * Filename suggests: work center table2
 *
...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM work_center_detail WHERE (id_work LIKE ?) or (wc_desc LIKE ?)"; $query8_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
