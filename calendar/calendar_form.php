    ...
    <div id="calendar-container">
        ...
        <div id="calendar-footer">
          <div class="btn">
			...
			?><a href="javascript:move('<?php echo(str_pad($previous_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($previous_year);?>');"><img src="../calendar/images/btn_<?php echo($rtl ? "next" : "previous"); ?>.png" width="16" height="16" border="0" alt="Previous" title="Previous" /></a>
			<?php
            }else echo("&nbsp;");
            ?>
            </div>
            ...
            ?><a href="javascript:move('<?php echo(str_pad($next_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($next_year);?>');"><img src="../calendar/images/btn_<?php echo($rtl ? "previous" : "next"); ?>.png" width="16" height="16" border="0" alt="Next" title="Next" /></a>
            <?php
            }else echo("&nbsp;");
            ?>
            </div>
