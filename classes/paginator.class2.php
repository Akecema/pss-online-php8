...
class Paginator{
	...
	function paginate()
	{
		...
		if($this->num_pages > 15)
		{
			...
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 15) And ($_GET['page'] != 'All')) ? "<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$next_page&ipp=$this->items_per_page$this->querystring\">Next &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">&raquo; Next</span>\n";
