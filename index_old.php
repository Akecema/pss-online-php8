 ...
 * Filename suggests: index old
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST); sends email.
 * Database tables referenced: sys_setup_maintain, user_detail, failed_login, status_failed.
 * Includes: config.php, config_mail.php, index_admin.php, backjob_clean.php, index_super.php.
 *
...
$_SESSION["password"] = $password;
		...
		$url = "index_admin.php";
			if($ua['name'] == "Google Chrome")
	{
		header ("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."admin/index_admin.php?page=".encode($url,11));
...
$_SESSION["password"] = $password;
 ...
 include 'backjob_clean.php';
		...
		if($ua['name'] == "Google Chrome")
	{
		header ("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."prod/index_production.php?page=".encode($url2,11));
	}elseif(($ua['name'] == "Apple Safari") || ($ua['name'] == "Mozilla Firefox") || ($ua['name'] == "Internet Explorer"))
	{
...
$_SESSION["password"] = $password;
		...
		if($ua['name'] == "Google Chrome")
	{
		header ("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."supply/index_supply.php?page=".encode($url6,11));
		}elseif(($ua['name'] == "Apple Safari") || ($ua['name'] == "Mozilla Firefox") || ($ua['name'] == "Internet Explorer"))
	{
...
$_SESSION["password"] = $password;
		...
		if($ua['name'] == "Google Chrome")
	{
		header ("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."supply_super/index_supply_super.php?page=".encode($url7,11));
		}elseif(($ua['name'] == "Apple Safari") || ($ua['name'] == "Mozilla Firefox") || ($ua['name'] == "Internet Explorer"))
	{
...
include 'backjob_clean.php';
		...
		if($ua['name'] == "Google Chrome")
	{
		header ("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."planning/index_planning.php?page=".encode($url8,11));
		}elseif(($ua['name'] == "Apple Safari") || ($ua['name'] == "Mozilla Firefox") || ($ua['name'] == "Internet Explorer"))
	{
...
$_SESSION["password"] = $password;
	...
	include 'backjob_clean.php';
		...
		if($ua['name'] == "Google Chrome")
	{
		header ("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."planning_super/index_planning_super.php?page=".encode($url9,11));
		}elseif(($ua['name'] == "Apple Safari") || ($ua['name'] == "Mozilla Firefox") || ($ua['name'] == "Internet Explorer"))
	{
...
$_SESSION["password"] = $password;
		...
		if($ua['name'] == "Google Chrome")
	{
		header ("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."qqc/index_qqc.php?page=".encode($url10,11));
		}elseif(($ua['name'] == "Apple Safari") || ($ua['name'] == "Mozilla Firefox") || ($ua['name'] == "Internet Explorer"))
	{
...
$_SESSION["password"] = $password;
		...
		if($ua['name'] == "Google Chrome")
	{
		header ("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."qqc_super/index_qqc_super.php?page=".encode($url11,11));
		}elseif(($ua['name'] == "Apple Safari") || ($ua['name'] == "Mozilla Firefox") || ($ua['name'] == "Internet Explorer"))
	{
		header ("Location: ".$data_setup["urls_system"]."/qqc_super/index_qqc_super.php");	
		 	...
		 	if($ua['name'] == "Google Chrome")
	    {
		header("Location: http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."blankPg.php"); 
