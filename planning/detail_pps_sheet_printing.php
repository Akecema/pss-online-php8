...
<br><table width="1050" border="0" cellpadding="2" cellspacing="2">
  ...
  <!--  <div class="page"> -->
   ...
   <!--   <tbody>-->
	  ...
	  $query_by_group = "SELECT *, DATE_FORMAT(date_plan,'%d-%m-%Y') AS T, DATE_FORMAT(date_upload,'%d-%m-%Y h:m:s') AS K from pps_detail WHERE upload_id = ? AND work_center = ?"; $query_by_group_args = [$upload_id, $db_rs["work_center"]];
