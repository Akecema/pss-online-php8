         ...
         <div class="row-fluid">
            ...
            <tr>
              ...
              <td><select name="plan_no" id="plan_no" class="span11">
                  ...
                  <?php
	             $query9 = "SELECT * FROM pps_detail WHERE status_pps = ? OR status_pps = ? ORDER BY plan_no ASC"; $query9_args = [$rst_sta["status_desc"], $rst_sta2["status_desc"]];
             ...
             <th>Filename :</th>
              <td>  <select name="name_file" id="name_file">
                  ...
                  <?php
	               $query19 = "SELECT * FROM pps_detail AS DC, ftp_pps AS FP  WHERE FP.upload_id = DC.upload_id AND (DC.status_pps != ? AND DC.status_pps != ?) GROUP BY FP.file_name ORDER BY FP.file_name ASC"; $query19_args = [$rst_sta4["status_desc"], $rst_sta13["status_desc"]];
                   $result19 = db_query_bind($dbc, $query19, $query19_args);
...
<?php
		...
		// 9. Plan Category
                if ($plan_category == "NULL" ){
                    $wheresql_09 = ""; $wheresql_09_args = []; }
                else {
                    $wheresql_09 = " AND plan_category = ?"; $wheresql_09_args = [$plan_category]; }          	
	                                        
				
				$where_sql =  $wheresql_01 .$wheresql_02 .$wheresql_03 .$wheresql_04 .$wheresql_05 .$wheresql_06 .$wheresql_07 .$wheresql_08 .$wheresql_09; $where_args = array_merge($wheresql_01_args, $wheresql_02_args, $wheresql_03_args, $wheresql_04_args, $wheresql_05_args, $wheresql_06_args, $wheresql_07_args, $wheresql_08_args, $wheresql_09_args);	
   ...
   $query8 = "SELECT COUNT(*) FROM pps_detail WHERE (status_pps != ? AND status_pps != ? AND status_pps != ?) ".$where_sql; $query8_args = [$rst_sta["status_desc"], $rst_sta4["status_desc"], $rst_sta16["status_desc"], ...$where_args];
...
$query = "SELECT *, DATE_FORMAT(date_plan,'%d-%m-%Y') as R FROM pps_detail WHERE (status_pps != ? AND status_pps != ? AND status_pps != ?) ".$where_sql. " ORDER BY plan_no ASC"; $query_args = [$rst_sta["status_desc"], $rst_sta4["status_desc"], $rst_sta16["status_desc"], ...$where_args];
