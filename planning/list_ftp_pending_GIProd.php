...
/**
 * planning/list_ftp_pending_GIProd.php
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_planning.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current">FTP Monitor</a></div>
  <h1>FTP Monitor</h1>
</div>
         ...
         <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="list_ftp_pending_GIProd.php">Good Issue</a></li>
             </ul>
          </div>
          </div>
