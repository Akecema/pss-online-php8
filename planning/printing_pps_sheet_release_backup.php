...
/**
 * planning/printing_pps_sheet_release_backup.php
 * Part of: Planning module
 * Filename suggests: printing pps sheet release backup
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: sys_setup_maintain, pps_detail, mat_master_header, mat_master_detail.
