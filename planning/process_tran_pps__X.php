...
/**
 * planning/process_tran_pps__X.php
 * Part of: Planning module
 * Filename suggests: process tran pps X
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: sys_setup_maintain, request_status, pps_detail, pps_upload, work_center_detail.
