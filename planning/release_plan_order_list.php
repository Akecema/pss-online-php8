...
/**
 * planning/release_plan_order_list.php
 * Part of: Planning module
 * Filename suggests: release plan order list
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, factory_detail, pps_detail.
      ...
      <form action="<?php echo h($_SERVER['PHP_SELF']); ?>" method="post" name="frmSearch" id="frmSearch">
            ...
            <tr>
              ...
              <td><select name="plan_no" id="plan_no" class="span11">
                  ...
                  <?php
	             $query9 = "SELECT * FROM pps_detail WHERE status_pps = ? ORDER BY plan_no ASC"; $query9_args = [$rst_sta2["status_desc"]];
            ...
            <tr>
              <th height="51">&nbsp;<font color="#FF0000">* Compulsory field</font></th>
              <th>&nbsp;</th>
              <th>&nbsp;</th>
...
<?php
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
echo "window.location='release_plan_order_list2.php?date1=$dateF&&date2=$dateT&&factory=$factory&&work_center=$work_center&&plan_no=$plan_no&&shift_ops=$shift_ops&&name_file=$name_file'";
            echo "</script>";
            exit(); //quit the script
        }
