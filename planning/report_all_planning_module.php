...
/**
 * planning/report_all_planning_module.php
 * Part of: Planning module
 * Filename suggests: report all planning module
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, factory_detail, pps_detail, mat_master_header.
