...
<?php
   ...
   $query8 = "SELECT COUNT(*) FROM pps_detail AS MR WHERE (MR.status_pps != '".db_esc($dbc, $rst_sta4["status_desc"])."' AND MR.status_pps != '".db_esc($dbc, $rst_sta16["status_desc"])."')".$where_sql;
