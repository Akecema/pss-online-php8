...
/**
 * planning/report_all_planning_module2.php
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_planning.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="current">Report Planned Order</a> </div>
...
<?php
   ...
   $query8 = "SELECT COUNT(*) FROM pps_detail AS MR WHERE (MR.status_pps != ? AND MR.status_pps != ?)".$where_sql; $query8_args = [$rst_sta4["status_desc"], $rst_sta16["status_desc"], ...$where_args];
