 ...
 * Database tables referenced: user_detail, sys_setup_maintain, login_detail, material_request, consumable_request, wip_request.
 * Includes: config.php, paginator.class2.php, tc_calendar.php, top_modal_menu.php, left_planning_super_menu.php, footer.php.
 *
...
<!--sidebar-menu-->
<?php include "left_planning_super_menu.php";  ?>
<!--sidebar-menu-->
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index_planning_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
<!--End-breadcrumbs-->
<?php 
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
       <ul class="quick-actions">
        <li class="bg_lb"> <a href="posting_request_all_screen_LCD.php"> <i class="icon-exchange"></i> <span class="label label-important"><?php echo $num_mat_req;   ?></span> In Progress </a> </li>
        <li class="bg_ls"> <a href="posting_request_all_screen_LCD_consumable.php"> <i class="icon-th"></i><span class="label label-important"><?php echo $num_con_req;   ?></span> Released PPS</a> </li>
       <!--  <li class="bg_ly"> <a href="#"> <i class="icon-bar-chart"></i><span class="label label-important"><?php echo $num_wip_req;   ?></span>Open WIP Request</a> </li>
