<?php
/**
 * planning_super/top_modal_menu.php
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome <?php echo h($res['user_fullname']); ?></span><b class="caret"></b></a>
...
$queryu = "SELECT * from user_detail where user_no = ?"; $queryu_args = [$res["user_no"]];
...
$row = mysqli_fetch_row($resultu);   //how many records are there?
 ...
 <div id="myModal2" class="modal hide">
          ...
          <tr> 
            ...
            <td><input type="text" name="username1" size="30" id="username1" value="<?php if (isset($_POST['username1'])) echo htmlspecialchars($_POST['username1'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="Enter your username"></td>
          </tr>
          <tr> 
