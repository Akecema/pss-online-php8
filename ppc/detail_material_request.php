...
/**
 * ppc/detail_material_request.php
	  ...
	  $sta = "Invalid";
		...
		if(($row["bom_qty"] != "") && ($row["bom_qty"] != "0.000"))
		{
		 ...
		 ?>
                ...
                <td width="45"><?php echo h($row["bom_oum"]); ?></td>
                <td width="120"><?php echo h($row_scan["prod_order"]); ?></td>
                <td width="93"><?php  echo h($row4_p["material"]); ?></td>
                <td width="45"><font color="#FF0000"><?php echo h($row1_p["work_center"]); ?></font></td>
                <td width="55"><?php echo $sta; ?></td>
                <td width="55"><font color="#FF0000"><?php echo h($row4_p["isloc"]); ?></font></td> 
                <td width="90"><?php echo h($row["bom_qty"]); ?>&nbsp;</td>
                <td width="90">
	              <div align="right">
	                <?php 
	...
	while($row_tp = mysqli_fetch_assoc($result_tp))
   {
	...
	$outs_qty1 = number_format($outs_qty,3);
	 ...
	 ?>
         ...
         <td width="80" height="28" bgcolor="#FFCC99"><div align="right"><?php echo h($outs_qty1); ?></div></td>
