...
$query = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR WHERE MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status  != 'Cancel') AND MR.status_print != 'Y' ".$where_sql." GROUP BY MR.temp_mrin ORDER BY MR.date_require DESC, MR.temp_mrin ASC";
...
?>
   ...
   $row_scan = mysqli_fetch_array($result_scan);
    ...
    <tr>
    <td width="265">&nbsp;<?php if($row2["status_view"] == "N") { echo "<b>";  echo $row2["temp_mrin"]."</b>"; } else {  echo h($row2["temp_mrin"]);  } ?></td>
