...
?>
   ...
   $row_scan = mysqli_fetch_array($result_scan);
    ...
    <tr>
    <td width="265">&nbsp;<?php if($row2["status_view"] == "N") { echo "<b>";  echo $row2["temp_mrin"]."</b>"; } else {  echo $row2["temp_mrin"];  } ?></td>
    <td width="126"><div align="center"><?php echo $row2["factory"]; ?></div></td>
    <td width="120"><?php echo $row2["R"]; ?> &nbsp;&nbsp;</td>
    <td width="104"><?php echo $row2["time_require"]; ?></td>
    <td width="146"><?php echo $data_u["user_fullname"]; ?></td>
    <td><div align="center">
     <?php
...
elseif($curr_time >= $plus_20)
{
	...
	?>
            ...
            <td width="65"><a value="Details" href="detail_consumable_request.php?mrin_no=<?php echo $row2["temp_mrin"]; ?>&&TB_iframe=true&&height=400&&width=800" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
           <td width="50"><a href="detail_consumable_request_printing.php?mrin_no=<?php echo $row2["temp_mrin"]; ?>&&TB_iframe=true&&height=400&&width=800" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>
