...
/**
 * ppc/manual_upload_TPWIP_file.php
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_ppc.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">Manually Upload File Transfer (TP)</a><a href="#" class="current">Uploaded TPWIP</a></div>
...
<td width="50%" style=" padding:5px;"><input name="submit" type="button" value=" Upload WIP File" onclick="window.open('http://10.10.20.118/PSS_upload/upload_WP_ipsb.php','_blank')" class="btn btn-success" /></td>
</tr>
</table>
