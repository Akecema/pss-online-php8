...
/**
 * ppc/posting_request_history2.php
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_ppc.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Material Request</a> <a href="#" class="current">Material Request History</a> </div>
...
$query = "SELECT *, DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R FROM material_request_close AS MR, scan_detail AS SD WHERE MR.id_scan = SD.id_scan AND MR.status_request = 'Y' AND  MR.status = 'Close' ".$where_sql." GROUP BY MR.temp_mrin ORDER BY MR.date_posting DESC, MR.temp_mrin DESC"; $query_args = [...$where_args];
