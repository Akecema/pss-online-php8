...
/**
 * ppc_store/cancel_ret_posting_to_plbProc.php
 * Part of: PPC Store module
 * Filename suggests: cancel ret posting to plbProc
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, ret_plb_detail.
...
<div id="content-header">
  ...
  <h1>Cancel Document Return from PLB</h1>
</div>
        ...
        <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="cancel_ret_posting_to_plb.php">Return from PLB</a></li>
 ...
 <?php              
   ...
   $query8 = "SELECT * FROM ret_plb_detail WHERE status_tran = 'Y' AND status_tp = ? ".$where_sql." GROUP BY doc_tp"; $query8_args = [$rst_sta20["status_desc"], ...$where_args];
...
$query_sql2 = "SELECT *, DATE_FORMAT(posting_date,'%d-%m-%Y') as R2 FROM ret_plb_detail WHERE status_tran = 'Y' AND status_tp = ?".$where_sql. " GROUP BY doc_tp ORDER BY posting_date DESC, posting_time DESC"; $query_sql2_args = [$rst_sta20["status_desc"], ...$where_args];
