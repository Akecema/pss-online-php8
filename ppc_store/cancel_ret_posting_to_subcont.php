...
/**
 * ppc_store/cancel_ret_posting_to_subcont.php
 * Part of: PPC Store module
 * Filename suggests: cancel ret posting to subcont
 *
	...
	?></td>
      ...
      <tr></form>
        ...
        {   
            ...
            echo "<script>";
		   echo "window.location='cancel_ret_posting_to_subcontProc.php?doc_tp_from=$doc_tp_from&&doc_tp_to=$doc_tp_to&&shift_day=$shift_day&&date1=$dateF&&date2=$dateT&&material_no=$material_no&&vendor_no=$vendor_no'";
            echo "</script>";
