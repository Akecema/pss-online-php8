...
/**
 * ppc_store/cancel_ret_posting_to_subcontProc.php
 * Part of: PPC Store module
 * Filename suggests: cancel ret posting to subcontProc
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, vendor_detail, ret_subcont_detail.
...
<div id="content-header">
  ...
  <h1>Cancel Document Return from Subcont</h1>
</div>
        ...
        <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              <li><a  role="tab" href="cancel_trans_posting_to_store.php">TP to Store</a></li>
              ...
              <li class="active"><a role="tab" href="cancel_ret_posting_to_subcont.php">Return from Subcont</a></li>
             </ul>
 ...
 ?>        
          <form action="<?php echo h($_SERVER['PHP_SELF']); ?>" method="get" name="frmSearch" id="frmSearch">
            <table class="table table-bordered table-striped">
              ...
              <th>Vendor  No. :</th>
              <td>	
    <select name="vendor_no" class="span11">
 ...
 <?php              
   ...
   $query8 = "SELECT * FROM ret_subcont_detail WHERE status_tran = 'Y' AND status_tp = ? ".$where_sql." GROUP BY doc_tp"; $query8_args = [$rst_sta20["status_desc"], ...$where_args];
...
$query_sql2 = "SELECT *, DATE_FORMAT(posting_date,'%d-%m-%Y') as R2 FROM ret_subcont_detail WHERE status_tran = 'Y' AND status_tp = ?".$where_sql. " GROUP BY doc_tp ORDER BY posting_date DESC, posting_time DESC"; $query_sql2_args = [$rst_sta20["status_desc"], ...$where_args];
...
//$num = mysqli_num_rows($result_sql2);   //how many material are there?
 ...
 <?php
   ...
   <tr class="gradeX">
    ...
    <td width="100"><div align="center"><a value="Cancel Document Return from Subcont" href="cancel_return_to_subcont.php?uid=<?php echo h($data_sql3["doc_tp"]); ?>&&TB_iframe=true&height=400&width=850" class="thickbox" target="_self"><img src="../img/font_red_delete.png" width="16" height="16" alt="Cancel Document Return from Subcont">Cancel</a></div></td>
  </tr>
