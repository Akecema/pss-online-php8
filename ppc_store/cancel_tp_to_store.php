...
<br>
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Cancel TP to Store   : [<?php echo h($doc_tp);   ?>]</h5>
          </div>
        ...
        <br>  
              <!-- End Box Head -->
            <form method="post" action="cancel_tp_to_store.php?uid=<?php echo h($doc_tp); ?>" >
            <table class="table table-bordered">
               <thead>
               <tr>
                 <th>Item</th>
 ...
 $no = sprintf('%03d', $no);
	 ...
	 ?>
               ...
               <tr>
                ...
                <td width="60"><div align="center"><?php echo h($row["slip_no"]); ?></div></td>
                <td width="146"><div align="center"><?php echo h($row["plan_no"]); ?></div></td>
                ...
                <input name="doc_tp" type="hidden" value="<?php echo h($doc_tp); ?> ">
          		<input name="plan_no" type="hidden" value="<?php echo h($row["plan_no"]); ?> ">
