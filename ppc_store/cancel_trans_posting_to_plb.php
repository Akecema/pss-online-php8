...
/**
 * ppc_store/cancel_trans_posting_to_plb.php
 * Part of: PPC Store module
 * Filename suggests: cancel trans posting to plb
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status.
...
?></td>
        ...
        {   
            ...
            echo "<script>";
		   echo "window.location='cancel_trans_posting_to_plbProc.php?doc_tp_from=$doc_tp_from&&doc_tp_to=$doc_tp_to&&shift_day=$shift_day&&date1=$dateF&&date2=$dateT&&material_no=$material_no'";
            echo "</script>";
