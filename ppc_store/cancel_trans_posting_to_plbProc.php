...
//$num = mysqli_num_rows($result_sql2);   //how many material are there?
 ...
 <?php
   ...
   <tr class="gradeX">
    ...
    <td width="100"><div align="center"><a value="Cancel Document Transfer to PLB" href="cancel_tp_to_plb.php?uid=<?php echo $data_sql3["doc_tp"]; ?>&&TB_iframe=true&height=400&width=850" class="thickbox" target="_self"><img src="../img/font_red_delete.png" width="16" height="16" alt="Cancel Document Transfer to PLB">Cancel</a></div></td>
  </tr>
