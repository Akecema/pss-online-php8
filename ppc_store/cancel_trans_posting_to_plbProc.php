...
/**
 * ppc_store/cancel_trans_posting_to_plbProc.php
 * Part of: PPC Store module
 * Filename suggests: cancel trans posting to plbProc
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, tp_plb_detail.
...
<div id="content-header">
  ...
  <h1>Cancel Document Transfer to PLB</h1>
</div>
        ...
        <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="cancel_trans_posting_to_plb.php">TP to PLB</a></li>
 ...
 <?php              
   ...
   $query8 = "SELECT * FROM tp_plb_detail WHERE status_tran = 'Y' AND status_tp = ? ".$where_sql." GROUP BY doc_tp"; $query8_args = [$rst_sta19["status_desc"], ...$where_args];
...
$query_sql2 = "SELECT *, DATE_FORMAT(posting_date,'%d-%m-%Y') as R2 FROM tp_plb_detail WHERE status_tran = 'Y' AND status_tp = ?".$where_sql. " GROUP BY doc_tp ORDER BY posting_date DESC, posting_time DESC"; $query_sql2_args = [$rst_sta19["status_desc"], ...$where_args];
...
//$num = mysqli_num_rows($result_sql2);   //how many material are there?
 ...
 <?php
   ...
   while ($data_sql2 = mysqli_fetch_array($result_sql2))
   {
	 ...
	 $query_sql3 = "SELECT *, DATE_FORMAT(posting_date,'%d-%m-%Y') as R3 FROM tp_plb_detail WHERE status_tran = 'Y' AND doc_tp = ?  ORDER BY doc_tp ASC"; $query_sql3_args = [$data_sql2["doc_tp"]];
   ...
   <tr class="gradeX">
    ...
    <td width="100"><div align="center"><a value="Cancel Document Transfer to PLB" href="cancel_tp_to_plb.php?uid=<?php echo h($data_sql3["doc_tp"]); ?>&&TB_iframe=true&height=400&width=850" class="thickbox" target="_self"><img src="../img/font_red_delete.png" width="16" height="16" alt="Cancel Document Transfer to PLB">Cancel</a></div></td>
  </tr>
