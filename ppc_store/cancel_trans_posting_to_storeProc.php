...
<div id="content-header">
 ...
 <?php              
   ...
   $query8 = "SELECT * FROM tp_store_detail WHERE status_tran = 'Y' AND status_tp = ?".$where_sql." GROUP BY doc_tp"; $query8_args = [$rst_sta19["status_desc"], ...$where_args];
...
$query_sql2 = "SELECT *, DATE_FORMAT(posting_date,'%d-%m-%Y') as R2 FROM tp_store_detail WHERE status_tran = 'Y' AND status_tp = ? ".$where_sql. " GROUP BY doc_tp ORDER BY posting_date DESC, posting_time DESC"; $query_sql2_args = [$rst_sta19["status_desc"], ...$where_args];
...
//$num = mysqli_num_rows($result_sql2);   //how many material are there?
 ...
 <?php
   ...
   <tr class="gradeX">
    ...
    <td width="70"><?php echo h($data_sql3["slip_no"]);  ?></td>
    <td width="70"><?php echo $shift_desc;  ?></td>
    <td width="100"><?php echo h($data_sql3["doc_tp"]);  ?></td>
    <td width="100"><div align="center"><a value="Cancel Document Transfer to Store" href="cancel_tp_to_store.php?uid=<?php echo h($data_sql3["doc_tp"]); ?>&&TB_iframe=true&height=400&width=850" class="thickbox" target="_self"><img src="../img/font_red_delete.png" width="16" height="16" alt="Cancel Document Transfer to Store">Cancel</a></div></td>
  </tr>
