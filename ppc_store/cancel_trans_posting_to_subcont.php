...
/**
 * ppc_store/cancel_trans_posting_to_subcont.php
 * Part of: PPC Store module
 * Filename suggests: cancel trans posting to subcont
 *
	...
	?></td>
      ...
      <tr></form>
        ...
        {   
            ...
            echo "<script>";
		   echo "window.location='cancel_trans_posting_to_subcontProc.php?doc_tp_from=$doc_tp_from&&doc_tp_to=$doc_tp_to&&shift_day=$shift_day&&date1=$dateF&&date2=$dateT&&material_no=$material_no&&vendor_no=$vendor_no'";
            echo "</script>";
