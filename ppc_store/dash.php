  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
       <ul class="quick-actions">
        <li class="bg_lb"> <a href="trans_posting_to_store.php"> <i class="icon-arrow-right"></i><span class="label label-important"><?php echo h($num_tp_store);   ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TP to Store&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> </li>
        <li class="bg_lv"> <a href="trans_posting_to_plb.php"> <i class="icon-arrow-right"></i><span class="label label-important"><?php echo h($num_tp_plb);   ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TP to PLB &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> </li>
        <li class="bg_ly"> <a href="trans_posting_to_subcont.php"> <i class="icon-arrow-right"></i><span class="label label-important"><?php echo h($num_tp_subcont);   ?></span>TP to Subcont</a> </li>
         <li class="bg_lv"> <a href="return_posting_to_plb.php"> <i class="icon-exchange"></i><span class="label label-important"><?php echo h($num_ret_plb);   ?></span>&nbsp;&nbsp;&nbsp;&nbsp;Return from PLB&nbsp;&nbsp;&nbsp;&nbsp;</a> </li>
           <li class="bg_ly"> <a href="return_posting_to_subcont.php"> <i class="icon-exchange"></i><span class="label label-important"><?php echo h($num_ret_subcont);   ?></span>Return from Subcont</a> </li>
             <li class="bg_lo"> <a href="cancel_trans_posting_to_store.php"> <i class="icon-remove-sign"></i><span class="label label-important"><?php echo h($num_cancel_tp_store);   ?></span>&nbsp;&nbsp;Cancel TP to Store&nbsp;&nbsp;</a> </li>
               <li class="bg_lo"> <a href="cancel_trans_posting_to_plb.php"> <i class="icon-remove-sign"></i><span class="label label-important"><?php echo h($num_cancel_tp_plb);   ?></span>&nbsp;&nbsp;Cancel TP to PLB&nbsp;&nbsp;</a> </li>
                 <li class="bg_lo"> <a href="cancel_trans_posting_to_subcont.php"> <i class="icon-remove-sign"></i><span class="label label-important"><?php echo h($num_cancel_tp_subcont);   ?></span>Cancel TP to Subcont</a> </li>
       </ul>
    </div>
<!--End-Action boxes-->    
