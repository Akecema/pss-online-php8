...
/**
 * ppc_store/document_list_RT_to_plb.php
 * Part of: PPC Store module
 * Filename suggests: document list RT to plb
 *
...
?></td>
        ...
        {   
            ...
            echo "<script>";
		   echo "window.location='document_list_RT_to_plbProc.php?doc_tp_from=$doc_tp_from&&doc_tp_to=$doc_tp_to&&shift_day=$shift_day&&date1=$dateF&&date2=$dateT&&material_no=$material_no'";
            echo "</script>";
