...
/**
 * ppc_store/document_list_RT_to_plbProc.php
 * Part of: PPC Store module
 * Filename suggests: document list RT to plbProc
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, ret_plb_detail, ret_plb_cancel.
...
<div id="content-header">
  ...
  <h1>Document List Return from PLB</h1>
</div>
        ...
        <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="document_list_RT_to_plb.php">Return from PLB</a></li>
 ...
 <?php              
   ...
   $query8 = "SELECT * FROM ret_plb_detail WHERE status_tran = 'Y' ".$where_sql." GROUP BY doc_tp"; $query8_args = [...$where_args];
   ...
   $query8a = "SELECT * FROM ret_plb_cancel WHERE status_tran = 'Y' ".$where_sql." GROUP BY doc_tp"; $query8a_args = [...$where_args];
...
$query_sql2 = "SELECT *, DATE_FORMAT(posting_date,'%d-%m-%Y') as R2 FROM ret_plb_detail WHERE status_tran = 'Y' ".$where_sql. " GROUP BY doc_tp ORDER BY posting_date DESC, posting_time DESC"; $query_sql2_args = [...$where_args];
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_document_list_return_to_plb_download.php?doc_tp_from=<?php echo h($doc_tp_from); ?>&&doc_tp_to=<?php echo h($doc_tp_to); ?>&&shift_day=<?php echo h($shift_day); ?>&date1=<?php echo h($dateF); ?>&&date2=<?php echo h($dateT); ?>&&material_no=<?php echo h($material_no); ?>" ><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
