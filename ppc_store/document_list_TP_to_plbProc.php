...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_document_list_TP_to_plb_download.php?doc_tp_from=<?php echo $doc_tp_from; ?>&&doc_tp_to=<?php echo $doc_tp_to; ?>&&shift_day=<?php echo $shift_day; ?>&date1=<?php echo $dateF; ?>&&date2=<?php echo $dateT; ?>&&material_no=<?php echo $material_no; ?>" ><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
