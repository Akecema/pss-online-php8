...
/**
 * ppc_store/document_list_TP_to_store.php
 * Part of: PPC Store module
 * Filename suggests: document list TP to store
 *
...
?></td>
        ...
        {   
            ...
            echo "<script>";
		   echo "window.location='document_list_TP_to_storeProc.php?doc_tp_from=$doc_tp_from&&doc_tp_to=$doc_tp_to&&shift_day=$shift_day&&date1=$dateF&&date2=$dateT&&material_no=$material_no'";
            echo "</script>";
