...
if(is_dir($dir)){
 ...
 {  ?> 
  <tr>
    ...
    <td width="15%"><?php echo $row_rs["qty_ftp"]; ?></td>
   <!-- <td width="10%"><?php //echo $row_mat_type["mat_type"]; ?></td>-->
    <td width="15%"><?php echo $row_rs["R3"];  ?></td>
 ...
 {  ?>
   <tr>
    ...
    <td width="15%"><?php  echo $row_rs_cancel["qty_ftp"]; ?></td>
   <!-- <td width="10%"><?php  //echo $row_mat_type_c["mat_type"]; ?></td>-->
    <td width="15%"><?php  echo $row_rs_cancel["R7"];  ?></td>
