...
/**
 * ppc_store/list_ftp_tr_plb.php
 * Part of: PPC Store module
 * Filename suggests: list ftp tr plb
 *
 * Behavior: requires an active login session ($_SESSION['username']).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, ftp_tp_plb, table_material, ftp_tp_cancel_plb.
    ...
    <div class="row-fluid">
         <div class="widget-box">
          <div class="widget-title">
              ...
              <li class="active"><a role="tab" href="list_ftp_tr_plb.php">TP to PLB</a></li>
...
$path = "../../PSS_Online/FromPortal3/TP_PLB/"; 

// Open the folder
 $dir_handle = @opendir($root . $path) or die("Unable to open $path");

$dir = "$root/FromPortal3/TP_PLB/";

$folder = "../../PSS_Online/FromPortal3/TP_PLB/";
$filetype = '*.*';    
...
$dir = "$root/PSS_Online/FromPortal3/TP_PLB/";
...
if(is_dir($dir)){
  ...
  <!--  <td width="10%">Material Type</td>-->
   ...
   <?php
	...
	$query = "SELECT *, DATE_FORMAT(date_create,'%d-%m-%Y %H:%i:%s') AS R2, DATE_FORMAT(posting_date,'%d-%m-%Y') AS R3 FROM ftp_tp_plb WHERE status_ftp = 'Y' AND file_name = ?"; $query_args = [$filename2];
 ...
 <?php  
   ...
   mysqli_free_result($rs); 
    ...
    $query_cancel = "SELECT *,DATE_FORMAT(date_create,'%d-%m-%Y %H:%i:%s') AS R8, DATE_FORMAT(posting_date,'%d-%m-%Y') AS R7 FROM ftp_tp_cancel_plb WHERE status_ftp = 'Y' AND file_name = ?"; $query_cancel_args = [$filename2];
 ...
 {  ?>
   <tr>
    ...
    <td width="20%"><?php  echo h($row_rs_cancel["qty_ftp"]); ?></td>
