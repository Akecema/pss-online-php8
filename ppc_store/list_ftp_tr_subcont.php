...
if(is_dir($dir)){
  ...
  $total2 = count($dh);  
   ...
   <?php
	...
	$rs_vendor = mysql_query($query_vendor);   //run the query.
	$row_vendor = mysql_fetch_array($rs_vendor);   //how many material are there?	
...
//-----------------cancel ----------------
	...
	$rs_vendor_cancel = mysql_query($query_vendor_cancel);   //run the query.
	$row_vendor_cancel = mysql_fetch_array($rs_vendor_cancel);   //how many material are there?				 
