...
/**
 * ppc_store/print_gdo_sdo.php
 * Part of: PPC Store module
 * Filename suggests: print gdo sdo
 *
...
?></td>
        ...
        {   
            ...
            echo "<script>";
		   echo "window.location='print_gdo_sdoProc.php?doc_tp_from=$doc_tp_from&&doc_tp_to=$doc_tp_to&&shift_day=$shift_day&&date1=$dateF&&date2=$dateT&&material_no=$material_no'";
            echo "</script>";
