...
/**
 * ppc_store/print_gdo_sdoProc.php
 * Part of: PPC Store module
 * Filename suggests: print gdo sdoProc
 *
...
<div id="content-header">
  ...
  <h1>Print General Delivery Order</h1>
</div>
        ...
        <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              <li class="active"><a  role="tab" href="print_gdo_sdo.php">GDO</a></li>
              <li><a role="tab" href="print_gdo_sdo2.php">SDO</a></li>
             </ul>
          </div>
...
//$num = mysqli_num_rows($result_sql2);   //how many material are there?
 ...
 <?php
   ...
   <tr class="gradeX">
    ...
    <td width="100"><div align="center"><a value="General Delivery Order" href="print_general_delivery_order.php?uid=<?php echo base64_encode($data_sql3["doc_tp"]); ?>" target="_blank"><img src="../img/pdf-download.png" width="30" height="30" alt="General Delivery Order"></a></div></td>
  </tr>
