...
/**
 * ppc_super/ST_manual_uploadProc.php
 * Part of: PPC module (supervisor/admin tier)
 * Filename suggests: ST manual uploadProc
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, sys_setup_maintain, consumable_detail, ftp_detail_consumable.
...
<div id="content">
 <div id="content-header" class="noprint">
  <div id="breadcrumb"> <a href="index_ppc_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">Uploaded MIGO TR </a><a href="#" class="current">Uploaded ST</a></div>
...
?></td>
   ...
   $query8 = "SELECT *,DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R FROM ftp_detail_consumable AS MR WHERE MR.mrin_no != '' " .$where_sql; $query8_args = [...$where_args];
...
$query = "SELECT *,DATE_FORMAT(MR.transfer_date,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM ftp_detail_consumable AS MR WHERE MR.mrin_no != '' ".$where_sql; $query_args = [...$where_args];
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_ST_manual_uploadProc.php?date1=<?php echo h($dateF); ?>&&date2=<?php echo h($dateT); ?>&&material_no=<?php echo h($material_no); ?>"><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
    ...
    <table class="table table-bordered data-table">
     <thead>
      <tr>
          ...
          <th width="151" height="28" bgcolor="#E9F58D"><span class="style3">Material No.</span></th>
          <th width="90" height="28" bgcolor="#E9F58D"><span class="style3">Mat. Doc</span></th>
          <th width="65" height="28" bgcolor="#E9F58D"><span class="style3">Mat. Doc Item</span></th>
          <th width="50" height="28" bgcolor="#E9F58D"><span class="style3">Mat. Doc Year</span></th>
          <th width="89" height="28" bgcolor="#E9F58D"><span class="style3">Transfer <br />Date</span></th>
          <th width="80" height="28" bgcolor="#E9F58D" class="ac style3"><div align="center">Posting Date</div></th>
          <th width="60" bgcolor="#E9F58D" class="ac style3">Posting Time </th>
          <th bgcolor="#E9F58D" class="ac style3">Filename Transfer Doc.</th>
      </tr>
          </thead><tbody>
