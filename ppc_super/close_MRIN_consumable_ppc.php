...
/**
 * ppc_super/close_MRIN_consumable_ppc.php
 * Part of: PPC module (supervisor/admin tier)
 * Filename suggests: close MRIN consumable ppc
 *
  ...
  <div class="row-fluid">
       ...
       <?php
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
			echo "window.location='close_MRIN_consumable_ppc2.php?temp_mrin=$temp_mrin&&date1=$dateF&&date2=$dateT&&factory=$factory'";
...
$query = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR WHERE MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status != 'Cancel') GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC, MR.temp_mrin ASC ";
