...
/**
 * ppc_super/close_MRIN_consumable_ppc__X.php
 * Part of: PPC module (supervisor/admin tier)
 * Filename suggests: close MRIN consumable ppc X
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: factory_detail, consumable_request, material_request, user_detail.
 * Includes: config.php, paginator.class2.php, tc_calendar.php, td>
              <td width=.
 *
...
?></td>
	       ...
	       $query3 = "SELECT * FROM factory_detail GROUP BY factory_desc2 ORDER BY id_fac ASC";
				...
				?>
                        ...
                        <td height="25" colspan="2"><input name="temp_mrin" type="text" id="temp_mrin" size="25" style="background:#FFFF97" />
...
$query = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR WHERE MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status != 'Cancel') GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC, MR.temp_mrin ASC $pages->limit";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px #d5d5d5;">
  ...
  <tr>
    ...
    <td width="50"><?php echo h($row2["factory"]); ?></td>
     <td width="50" height="28"><?php echo h($row2["id_work"]); ?></td>
              ...
              <td width="50"><a value="Details" href="close_MRIN_consumable_manual.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&user_no=<?php echo h($data_u["user_no"]); ?>&amp;&amp;TB_iframe=true&amp;height=400&amp;width=1000" class="thickbox" target="_self"><img src="../images/exclamation.png" width="16" height="16" alt="View" />Close</a></td>
         
            <td width="50"><a value="Details" href="detail_consumable_request.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../images/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
                <td width="50"><a href="detail_consumable_request_printing.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../images/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>
</table>    
  <?php 
