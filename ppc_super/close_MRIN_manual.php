	   ...
	   while ($row2 = mysqli_fetch_array($result_tp))
{
 ...
 $query_upd3 = "UPDATE material_request SET status = 'Close', user_update = '$user_no', date_update = NOW() WHERE temp_mrin = '$temp_mrin'";
