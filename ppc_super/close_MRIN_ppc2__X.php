...
/**
 * ppc_super/close_MRIN_ppc2__X.php
 * Part of: PPC module (supervisor/admin tier)
 * Filename suggests: close MRIN ppc2 X
 *
  ...
  <tr>
    ...
    <td width="50"><?php echo h($row_scan["factory"]); ?></td>
     <td width="50" height="28"><?php echo h($row_scan["work_center"]); ?></td>
              ...
              <td width="50"><a value="Details" href="close_MRIN_manual.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&prod_order=<?php echo h($row2["prod_order"]); ?>&amp;&amp;TB_iframe=true&amp;height=400&amp;width=1000" class="thickbox" target="_self"><img src="../images/exclamation.png" width="16" height="16" alt="View" />Close</a></td>
