 ...
 * Database tables referenced: user_detail, sys_setup_maintain, login_detail, material_request, consumable_request.
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index_ppc_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
<!--End-breadcrumbs-->
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="posting_request_all.php"> <i class="icon-exchange"></i> <span class="label label-important"><?php echo h($num_mat_req);   ?></span> Open Material Request </a> </li>
        <li class="bg_ls"> <a href="display_consumable_request.php"> <i class="icon-barcode"></i><span class="label label-important"><?php echo h($num_con_req);   ?></span> Open Consumable Request</a> </li>
        <!--  <li class="bg_ly"> <a href="#"> <i class="icon-inbox"></i><span class="label label-important"><?php //echo $num_wip_req;   ?></span>Open WIP Request</a> </li>
