  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="posting_request_all.php"> <i class="icon-exchange"></i> <span class="label label-important"><?php echo $num_mat_req;   ?></span> Open Material Request </a> </li>
        <li class="bg_ls"> <a href="display_consumable_request.php"> <i class="icon-barcode"></i><span class="label label-important"><?php echo $num_con_req;   ?></span> Open Consumable Request</a> </li>
