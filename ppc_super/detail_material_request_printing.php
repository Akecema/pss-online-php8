...
/**
 * ppc_super/detail_material_request_printing.php
...
<!--<body onload="window.print();  parent.tb_remove(); parent.location.reload(1);" >-->
...
<br>
 ...
 $no = sprintf('%03d', $no);
  ...
  $row4_p = mysqli_fetch_array($result4_p); 
	...
	?>
    <tr><td width="100"><?php  echo h($row4_p["bill_component"]); ?></td>
        <td width="122"><?php  echo h($row4_p["material_desc_c"]); ?></td>
        <td width="80"><div align="right"><?php echo h($row["bom_qty"]); ?>&nbsp;</div></td>
	...
	while($row_tp = mysqli_fetch_assoc($result_tp))
   {
	...
	$outs_qty1 = number_format($outs_qty,3);
	 ...
	 ?>
      ...
      <td width="60"><div align="center"><font color="#FF0000"><?php echo h($row4_p["isloc"]); ?></font></div></td>
      <td width="60">&nbsp;</td>
      <td height="60">
      <div align="left">
       <?php
