...
/**
 * ppc_super/detail_material_request_printing_backup.php
 * Part of: PPC module (supervisor/admin tier)
 * Filename suggests: detail material request printing backup
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: material_request, factory_detail, user_detail, scan_detail, mat_master_header.
...
.page {
 ...
 @media print{
  ...
  .tfoot { display: table-footer-group; }
  @page {size: landscape}
  tr.page-break  { display: block; page-break-before: always; clear: both; break-before: always; margin-bottom:-0.5cm; } 
