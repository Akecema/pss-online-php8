...
/**
 * ppc_super/display_consumable_request2.php
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_ppc_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Consumable Request</a> <a href="#" class="current">Consumable Request</a> </div>
...
<div class="container-fluid">
 ...
 <?php
	...
	//********** END CONDITION **************
	 ...
	 $query8 = "SELECT * FROM consumable_request AS MR WHERE MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status  != 'Cancel') AND MR.status_print != 'Y' ".$where_sql." GROUP BY MR.temp_mrin"; $query8_args = [...$where_args];
...
$query = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR WHERE MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status  != 'Cancel') AND MR.status_print != 'Y' ".$where_sql." GROUP BY MR.temp_mrin ORDER BY MR.date_posting DESC, MR.temp_mrin ASC"; $query_args = [...$where_args];
...
?>
   ...
   $row_scan = mysqli_fetch_array($result_scan);
	...
	/*$query_again = "SELECT * FROM material_request WHERE status_request = 'Y' and id_scan = '".$row2[5]."' ORDER BY id_req ASC";
    ...
    <tr>
    <td width="265">&nbsp;<?php if($row2["status_view"] == "N") { echo "<b>";  echo h($row2["temp_mrin"])."</b>"; } else {  echo h($row2["temp_mrin"]);  } ?></td>
    <td width="126"><div align="center"><?php echo h($row2["factory"]); ?></div></td>
    <td width="120"><?php echo h($row2["R"]); ?> &nbsp;&nbsp;</td>
    <td width="104"><?php echo h($row2["time_require"]); ?></td>
    <td width="146"><?php echo h($data_u["user_fullname"]); ?></td>
    <td><div align="center">
     <?php
...
elseif($curr_time >= $plus_20)
{
	...
	?>
            ...
            <td width="65"><a value="Details" href="detail_consumable_request.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&TB_iframe=true&height=400&width=800" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
           <td width="50"><a href="detail_consumable_request_printing.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&TB_iframe=true&height=400&width=800" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>
