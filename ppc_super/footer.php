...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> 2017 &copy; <?php echo h($data_setup["title_desc"]); ?>. Brought to you by <a href="https://themedesigner.in">Themedesigner.in</a> </div>
</div>
<!--end-Footer-part--> 