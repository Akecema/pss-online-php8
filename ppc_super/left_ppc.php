...
exit();
   ...
   $query = "SELECT * from level_detail WHERE id_level = ?"; $query_args = [$res['level_id']];
   $result = db_query_bind($dbc, $query, $query_args); // Run the query
...
<li><a href="close_MRIN_consumable_ppc.php" target="mainFrame">Consumable Request Maintenance</a></li>
