...
<div id="sidebar"><a href="index_ppc_super.php" class="visible-phone"><i class="icon icon-home"></i> Home</a>
  <ul>
    <?php if ($url == "index_ppc_super.php"){ ?>
    <li class="active"><?php }else { echo "<li>"; } ?><a href="index_ppc_super.php"><i class="icon icon-home"></i> <span>Home</span></a> </li>
...
$rs = mysqli_query($dbc, $query);   //run the query.
     ...
     <?php if ($url == "close_MRIN_ppc.php"){ ?>
        <li class="active"><?php }else { echo "<li>"; } ?><a href="close_MRIN_ppc.php"><i class="icon icon-edit"></i><span>Material Request Maintenance</span></a></li>
     <?php if ($url == "close_MRIN_consumable_ppc.php"){ ?>
        <li class="active"><?php }else { echo "<li>"; } ?><a href="close_MRIN_consumable_ppc.php" ><i class="icon icon-edit"></i><span>Consumable Request Maintenance</span></a></li>
