...
/**
 * ppc_super/manual_upload_ST_file.php
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_ppc_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">Manually Upload File Transfer (TP)</a><a href="#" class="current">Uploaded ST</a></div>
...
<td width="50%" style=" padding:5px;"><input name="submit" type="button" value=" Upload ST File" onclick="window.open('http://10.10.20.118/PSS_upload/upload_ST_ipsb.php','_blank')" class="btn btn-success" /></td>
</tr>
</table>
