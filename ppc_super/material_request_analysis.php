...
/**
 * ppc_super/material_request_analysis.php
 * Part of: PPC module (supervisor/admin tier)
 * Filename suggests: material request analysis
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, factory_detail, mat_master_detail.
  ...
  <div class="container-fluid">
    ...
    <form action="<?php echo h($_SERVER['PHP_SELF']); ?>" method="post" name="frmSearch" id="frmSearch">
        ...
        if(isset($_POST["Submit"]))
        {
            ...
            echo "<script>";
		   echo "window.location='material_request_analysisProc.php?factory=$factory&&work_center=$work_center&&status=$status&&date1=$dateF&&date2=$dateT&&material_no=$material_no'";
            echo "</script>";
