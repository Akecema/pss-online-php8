...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_material_request_analysisProc.php?factory=<?php echo $factory; ?>&&work_center=<?php echo $work_center; ?>&&status=<?php echo $status; ?>&&date1=<?php echo $dateF; ?>&&date2=<?php echo $dateT; ?>&&material_no=<?php echo $material_no; ?>"><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
