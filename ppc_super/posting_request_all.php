...
/**
 * ppc_super/posting_request_all.php
 * Part of: PPC module (supervisor/admin tier)
 * Filename suggests: posting request all
 *
...
?></td>
      ...
      <?php
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
			echo "window.location='posting_request_all2.php?temp_mrin=$temp_mrin&&prod_order=$prod_order&&date1=$dateF&&date2=$dateT&&work_center=$work_center&&factory=$factory'";
