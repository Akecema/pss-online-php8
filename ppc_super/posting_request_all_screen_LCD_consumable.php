...
$rs = mysql_query($query) or trigger_error("SQL", E_USER_ERROR);
        ...
        if($result_upd3 || $result_upd4)
		 {
		   ...
		   $result_upd8 = mysql_query($query_upd8) or trigger_error("SQL", E_USER_ERROR);
		   $row_upd8 = mysql_num_rows($result_upd8); 
