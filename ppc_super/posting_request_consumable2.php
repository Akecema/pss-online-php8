...
/**
 * ppc_super/posting_request_consumable2.php
 ...
 * Includes: config.php, paginator.class2.php, tc_calendar.php, top_modal_menu.php, left_ppc_menu.php, ]., td>
            <td width=, footer.php.
 *
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_ppc_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Consumable Request</a> <a href="#" class="current">Display Consumable Request</a> </div>
  ...
  <div class="row-fluid">
	       ...
	       $query3 = "SELECT * FROM factory_detail GROUP BY factory_desc2 ORDER BY id_fac ASC";
            ...
            <tr>
              ...
              <th>&nbsp;</th>
              <th>&nbsp;</th>
              <td><input name="Submit" type="submit"  class="btn btn-info" id="button" value="SEARCH" /></td>
            </tr>
            </table>
        </form>
<?php
        ...
        if($result_upd3 || $result_upd4)
		 {
		   ...
		   $result_upd4 = db_query_bind($dbc, $query_upd4, $query_upd4_args) or die(db_fail($dbc));
