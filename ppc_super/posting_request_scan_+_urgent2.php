          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" name="frmSearch" id="frmSearch">
            <table class="table table-bordered table-striped">
              <tr>
                ...
                <tr>
                  <th>MRIN No :</th>
                  <td><input name="temp_mrin" type="text" id="temp_mrin" size="25" class="span11" value="<?php echo $_GET["temp_mrin"]; ?>" />
                  </td>
                  <th>Production Order :</th>
                  <td ><input name="prod_order" type="text" id="prod_order" size="25" class="span11" value="<?php echo $_GET["prod_order"]; ?>" />
                  </td>
                </tr>
                <tr>
                  <th>Factory :</th>
