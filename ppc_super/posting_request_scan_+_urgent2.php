...
<div class="container-fluid">
  ...
  <!--  <div class="span6">-->
   ...
   $query8 = "SELECT *, DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM material_request AS MR, scan_detail AS SD WHERE MR.id_scan = SD.id_scan AND MR.status_request = 'Y' ".$where_sql."  GROUP BY MR.temp_mrin ORDER BY MR.id_req ASC";
...
$query = "SELECT *, DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM material_request AS MR, scan_detail AS SD WHERE MR.id_scan = SD.id_scan AND MR.status_request = 'Y' ".$where_sql."  GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC, MR.temp_mrin ASC";
...
?>
   ...
   $row_scan = mysqli_fetch_array($result_scan);
	...
	$query_again = "SELECT * FROM material_request WHERE status_request = 'Y' and id_scan = '".db_esc($dbc, $row2[6])."'";
	...
	//------------------------------
	    ...
	    $query_check = "SELECT * FROM material_request WHERE temp_mrin = '".db_esc($dbc, $row2["temp_mrin"])."' AND status != 'New'";
	   ...
	   $stat = '<font color="#009900"><b>Open</b></font>';
	    ...
	    $query_check2 = "SELECT * FROM material_request_cancel WHERE temp_mrin = '".db_esc($dbc, $row2["temp_mrin"])."'";
