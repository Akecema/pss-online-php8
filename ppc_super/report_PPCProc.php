...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_ppc_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Material Request</a> <a href="#" class="current">Material Request Report</a> </div>
...
$since_start = $start_date->diff(new DateTime($date_transfer));
  ...
  <tr>
    ...
    <td width="50"><div align="center"><?php echo h($row_scan["factory"]); ?></div></td>
     <td width="50" height="28"><div align="center"><?php echo h($row_scan["work_center"]); ?></div></td>
            ...
            <td width="134"><?php echo h($data_u["user_fullname"]); ?></td>
              ...
              <td width="48"><a value="Details" href="detail_material_request_history.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&prod_order=<?php echo h($row2["prod_order"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
                <td width="55"><a href="detail_material_request_history_printing.php?mrin_no=<?php echo h($row["temp_mrin"]); ?>&&prod_order=<?php echo h($row2["prod_order"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>
