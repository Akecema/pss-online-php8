...
$since_start = $start_date->diff(new DateTime($date_transfer));
  ...
  <tr>
    <td width="143">&nbsp;<?php echo $row["temp_mrin"]; ?><?php if($row2["status_urgent"] == "Y") 
	{
	?>
    ...
    <td width="50"><div align="center"><?php echo $row_scan["factory"]; ?></div></td>
     <td width="50" height="28"><div align="center"><?php echo $row_scan["work_center"]; ?></div></td>
            ...
            <td width="134"><?php echo $data_u["user_fullname"]; ?></td>
              ...
              <td width="48"><a value="Details" href="detail_material_request_history.php?mrin_no=<?php echo $row2["temp_mrin"]; ?>&&prod_order=<?php echo $row2["prod_order"]; ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
                <td width="55"><a href="detail_material_request_history_printing.php?mrin_no=<?php echo $row["temp_mrin"]; ?>&&prod_order=<?php echo $row2["prod_order"]; ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>
