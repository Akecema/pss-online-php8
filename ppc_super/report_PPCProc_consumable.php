...
/**
 * ppc_super/report_PPCProc_consumable.php
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_ppc_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Consumable Request</a> <a href="#" class="current">Consumable Request Report</a> </div>
  ...
  <!--  <div class="span6">-->
          ...
          ?></td>
            ...
            <tr>
              ...
              <th>MRIN No : </th>
              <td colspan="2"><input name="temp_mrin" type="text" id="temp_mrin"  class="span11" value="<?php echo h($_GET["temp_mrin"]); ?>"/>
                      </td>
            </tr>
            <tr>
              <th>&nbsp;</th>
...
$since_start = $start_date->diff(new DateTime($date_transfer));
    ...
    <td width="50" ><div align="center"><?php echo h($row2["id_work"]); ?></div></td>
