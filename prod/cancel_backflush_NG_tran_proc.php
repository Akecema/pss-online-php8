...
<p>&nbsp;</p> 
   <form action="cancel_backflush_NG_tran_proc.php?buid=<?php echo $buid; ?>" method="post" name="frmSearch" id="frmSearch">    <table class="table table-bordered data-table">
    <thead>
      <tr>
        <th>No.</th>
