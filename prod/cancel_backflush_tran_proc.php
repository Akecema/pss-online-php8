...
<p>&nbsp;</p> 
   <form action="cancel_backflush_tran_proc.php?buid=<?php echo h($buid); ?>" method="post" name="frmSearch" id="frmSearch">    <table class="table table-bordered data-table">
    <thead>
      <tr>
        <th>No.</th>
