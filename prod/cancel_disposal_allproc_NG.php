...
$message = NULL; // create an empty new variable.
   ...
   if(isset($_POST["cancel"])) 
  {
    ...
    //-------------------generate disposal doc no. [Wastage Cancellation]---------------
	 
	 $query_id = "SELECT count_max FROM run_count_no WHERE uid = '26'";
 ...
 $result_upd4 = mysqli_query($dbc, $query_upd4); */
  ...
  //-----insert at table reject_detail_disposal_cancel -------
    ...
    //update count_max----------------------------------------
       ...
       $query_max_a = "UPDATE run_count_no SET count_max = '".$number."', date_updated = NOW() WHERE uid = '26'";
...
<table width="98%" class="table table-condensed">
 ...
 <!-- Form -->
            <div class="form" align="center">
              <!-- End Box Head -->
             <form name="myform" action="cancel_disposal_allproc_NG.php?doc_disposal=<?php echo $doc_disposal; ?>" method="post" >
