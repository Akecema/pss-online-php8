	   ...
	   while ($row2 = mysqli_fetch_array($result_tp))
{
 ...
 $query_upd3 = "UPDATE `wip_request` SET status = 'Cancel', user_update = '$user_no', date_update = NOW() WHERE temp_mrin_wip = '$temp_mrin' AND bom_component = '".$row4_p["bill_component"]."' ";
