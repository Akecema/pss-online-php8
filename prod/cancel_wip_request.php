	   ...
	   while ($row2 = mysqli_fetch_array($result_tp))
{
 ...
 $query_upd3 = "UPDATE `wip_request` SET status = 'Cancel', user_update = ?, date_update = NOW() WHERE temp_mrin_wip = ? AND bom_component = ? "; $query_upd3_args = [$user_no, $temp_mrin, $row4_p["bill_component"]];
...
?>
         ...
         <form action="cancel_wip_request.php?mrin_no=<?php echo h($temp_mrin); ?>&&prod_order=<?php echo h($prod_order); ?>" method="post" >
...
<?php 
  ...
  <?php
             ...
             <tr>
              ...
              <p>&nbsp;</p>
             <input type="submit" onClick="return confirm('Are you sure you want to CANCEL MRIN No. : <?php echo h($temp_mrin); ?>?');" name="submit" id="button" value="CANCEL MRIN" class="btn btn-success" />&nbsp;&nbsp; 
