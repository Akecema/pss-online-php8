...
//print_r(explode('|', $str, -1));
  ...
  //--------- check for closed planning order x bleh scan pps------------- 
    $query_check_pps = "SELECT * FROM pps_detail WHERE plan_no = ?"; $query_check_pps_args = [$part2];
	$result_check_pps = db_query_bind($dbc, $query_check_pps, $query_check_pps_args) or die(db_fail($dbc));
  ...
  $query_q2 = "SELECT * FROM mat_master_header WHERE material_no = ?"; $query_q2_args = [$part1];
