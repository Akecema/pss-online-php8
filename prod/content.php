...
$sql = "SELECT * FROM material_request AS MR WHERE MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status != 'Cancel') AND (MR.date_mrin >= ? AND MR.date_mrin <= ?) GROUP BY MR.temp_mrin"; $sql_args = [$start_date_check, $end_date_check];
