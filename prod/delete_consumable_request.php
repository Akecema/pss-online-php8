...
<p>
  ...
  $id_req_con = $_GET["id_req_con"];
   ...
   //--------------------------------------------------------------------------------------------------
    ...
    $query_delete = "DELETE FROM consumable_request WHERE id_req_con = ?"; $query_delete_args = [$id_req_con];
	$result_delete = db_query_bind($dbc, $query_delete, $query_delete_args);
