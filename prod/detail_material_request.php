 ...
 $no = sprintf('%03d', $no);
  ...
  $row4_p = mysqli_fetch_array($result4_p); 
	...
	} elseif($row4_p["mat_type"] == "Z210")	 
	{
	...
	} elseif($row4_p["mat_type"] == "Z310")
	 {
	  ...
	  $sta = "Invalid";
		...
		//echo $rst_check["id_post"];
		//echo $rst_check["rquantity"];
	...
	?>
                ...
                <td width="90">&nbsp;
                <?php
				if($rst_check > 0){ echo $rst_check["rquantity"]; } else{ }
				
				?>
                </td>
                <td width="65"><div align="center"><font color="#FF0000"><?php echo $row4_p["isloc"]; ?></font></div></td>
                <td>
                  <div align="left">
                    <?php
