...
/**
 * prod/detail_prod_order_urgent.php
 * Part of: Production module
 * Filename suggests: detail prod order urgent
 *
 ...
 $no = sprintf('%03d', $no);
  ...
  $row4_p = mysqli_fetch_array($result4_p); 
		 ...
		 ?>
			  ...
			  <td width="187"><?php  echo h($row4_p["material_desc_c"]); ?></td>
              <td width="100"><div align="right"><?php echo h($row["bom_qty"]); ?>&nbsp;</div></td>
              <td width="80"><div align="center"><?php echo h($row["bom_oum"]); ?></div></td>
              <td width="67">&nbsp;<font color="#FF0000"><?php echo h($row1_p["work_center"]); ?></font></td>
          </tr>
