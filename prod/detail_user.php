...
/**
 * prod/detail_user.php
 * Part of: Production module
 * Filename suggests: detail user
 *
...
<table width="650">
    <tr>
      <td width="1%">&nbsp;</td>
      <td width="85%"> <div class="small-nav"> User Maintenance&nbsp;&gt;Display Account &nbsp;&gt;View</div></td>
...
<div id="main2">
      ...
      <div id="subcontent">
        ...
        <div class="box">
          <!-- Box Head -->
          <div class="box-head">
            <h2><img src="../images/Login Manager.png" width="24" height="24" />View</h2>
          </div>
          <!-- End Box Head -->
