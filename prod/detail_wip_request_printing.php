...
/**
 * prod/detail_wip_request_printing.php
 ...
 $no = sprintf('%03d', $no);
  ...
  $row4_p = mysqli_fetch_array($result4_p); 
	...
	?>
                ...
                <td width="80" height="60"><div align="right"><?php echo h($row["bom_qty_wip"]); ?>&nbsp;</div></td>
                ...
                <td width="80">&nbsp;</td>
                <td width="60"><div align="center"><font color="#FF0000"><?php //echo h($row4_p["sloc"]); ?></font></div></td>
                 <td width="60">&nbsp;</td>
                <td height="60">
                  <div align="left">
                    <?php
