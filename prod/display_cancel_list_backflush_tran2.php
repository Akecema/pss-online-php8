...
<?php
          ...
          //4. Work Center
	       ...
	       //5. Backflush Doc. No.
                if ($bflush_no == "NULL"){ 
                    ...
                    $wheresql_05 = " AND MR.bflush_no = '".db_esc($dbc, $bflush_no)."'"; }  	
   ...
   $query8 = "SELECT COUNT(*) FROM pps_detail_transaction AS MR, work_center_detail AS SR WHERE SR.id_work = MR.work_center AND MR.status_pps = '".db_esc($dbc, $rst_sta4["status_desc"])."'".$where_sql;
