...
echo '<font color="red" class ="error_entry">', $message, '</font>';
  ...
  $query8 = "SELECT COUNT(*) FROM material_request AS MR, scan_detail AS SD WHERE MR.id_scan = SD.id_scan AND SD.status_urgent = 'Y' AND MR.status_request = 'N' AND MR.user_create = '".db_esc($dbc, $res["user_no"])."' AND ((MR.date_mrin >= '$current_date') AND (MR.date_mrin <= '$next_date')) ORDER BY MR.id_req ASC";
  ...
  <tr>
   <td><div align="center">
    ...
    <td>&nbsp;</td>
         ...
         <?php
	$query_again = "SELECT * FROM material_request WHERE status_request = 'N' and id_scan = '".db_esc($dbc, $row2[6])."'";
