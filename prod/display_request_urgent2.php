...
/**
 * prod/display_request_urgent2.php
 * Part of: Production module
 * Filename suggests: display request urgent2
 *
  ...
  <tr>
   <td><div align="center">
    ...
    <td>&nbsp;</td>
         ...
         <?php
	$query_again = "SELECT * FROM material_request WHERE status_request = 'N' and id_scan = ?"; $query_again_args = [$row2["id_scan"]];
