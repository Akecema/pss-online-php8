...
/**
 * prod/display_request_wip.php
 * Part of: Production module
 * Filename suggests: display request wip
 *
  ...
  <!--  <div class="span6">-->
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Display Request - WIP</h5>
           ...
           <form action="display_request_wip.php" method="post" name="form1" >
...
<?php
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
			echo "window.location='display_request_wip2.php?temp_mrin=$temp_mrin&&prod_order=$prod_order&&date1=$dateF&&date2=$dateT&&work_center=$work_center&&factory=$factory'";
   ...
   $query8 = "SELECT *, DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM wip_request AS MR, scan_detail_wip AS SD WHERE MR.id_scan_wip = SD.id_scan AND SD.status_urgent = 'N' AND MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status  != 'Cancel') GROUP BY MR.temp_mrin_wip ";
...
$data_u = mysqli_fetch_array($result_u);   //how many records are there?       
     ...
     <td width="70"><?php echo h($row_scan["work_center"]); ?></td>
...
elseif($curr_time >= $plus_20)
{
	...
	?></div></td>
              ...
              <td width="48"><a value="Details" href="detail_wip_request.php?mrin_no=<?php echo h($row2["temp_mrin_wip"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
                <td width="55"><a href="detail_wip_request_printing.php?mrin_no=<?php echo h($row2["temp_mrin_wip"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>
