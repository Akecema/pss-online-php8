...
/**
 * prod/display_request_wip_cancel.php
 * Part of: Production module
 * Filename suggests: display request wip cancel
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, factory_detail, wip_request, scan_detail_wip, wip_request_close, wip_request_cancel.
...
$url = "display_request_wip_cancel.php";
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_production.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">WIP Request</a> <a href="#" class="current">Cancel WIP Request</a> </div>
  <h1>WIP Request</h1>
</div>
...
<div class="container-fluid">
  ...
  <!--  <div class="span6">-->
            ...
            <form action="display_request_wip_cancel.php" method="post" name="frmSearch" id="frmSearch">
            ...
            <tr>
              ...
              <td><input name="prod_order" type="text" id="prod_order" size="25" class="span11" /></td>
            </tr>
            <tr>
              <th>Factory : </th>
...
<?php
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
echo "window.location='display_request_wip_cancel2.php?temp_mrin=$temp_mrin&&prod_order=$prod_order&&date1=$dateF&&date2=$dateT&&work_center=$work_center&&factory=$factory'";
    ...
    $query8 = "SELECT *, DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM wip_request AS MR, scan_detail_wip AS SD WHERE MR.id_scan_wip = SD.id_scan AND MR.status_request = 'Y' AND (MR.status != 'Close' AND MR.status  != 'Cancel') GROUP BY MR.temp_mrin_wip  ORDER BY MR.id_req_wip ASC";
...
elseif($curr_time >= $plus_20)
{
	...
	?>
                  ...
                  <td width="50"><a value="Details" href="cancel_wip_request.php?mrin_no=<?php echo h($row2["temp_mrin_wip"]); ?>&&prod_order=<?php echo h($row2["prod_order"]); ?>&&user_no=<?php echo h($res["user_no"]); ?>&amp;&amp;TB_iframe=true&amp;height=400&amp;width=1000" class="thickbox" target="_self"><img src="../img/delete.png" width="16" height="16" alt="Cancel" />Cancel</a></td>
