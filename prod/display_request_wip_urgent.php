...
/**
 * prod/display_request_wip_urgent.php
 * Part of: Production module
 * Filename suggests: display request wip urgent
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, factory_detail, wip_request, scan_detail_wip.
  ...
  <!--  <div class="span6">-->
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Display Request Urgent - WIP</h5>
            ...
            <form action="display_request_wip_urgent.php" method="post" name="form1">
   ...
   <?php
        ...
        echo "<script>";
		echo "window.location='display_request_wip_urgent2.php?temp_mrin=$temp_mrin&&prod_order=$prod_order&&date1=$dateF&&date2=$dateT&&work_center=$work_center&&factory=$factory'";
