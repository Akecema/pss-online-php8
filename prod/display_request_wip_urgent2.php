...
/**
 * prod/display_request_wip_urgent2.php
 * Part of: Production module
 * Filename suggests: display request wip urgent2
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, sys_setup_maintain, factory_detail, work_center_detail, wip_request, scan_detail_wip.
  ...
  <!--  <div class="span6">-->
          ...
          <div class="widget-title">
            <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="display_request_wip_urgent.php">Display Request</a></li>
            </ul>
          </div>
          </div>
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Display Request Urgent - WIP</h5>
        </div>
...
?>
       ...
       <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Display WIP Request Urgent</h5>
          </div>
   ...
   $row_scan = mysqli_fetch_array($result_scan);
    ...
    <tr>
    <td width="143">&nbsp;<?php echo h($row2["temp_mrin_wip"]); ?></td>
...
elseif($curr_time >= $plus_20)
{
	...
	?>
              ...
              <td width="48"><a value="Details" href="detail_wip_request.php?mrin_no=<?php echo h($row2["temp_mrin_wip"]); ?>&&TB_iframe=true&height=400&width=800" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
  <td width="55"><a href="detail_wip_request_printing.php?mrin_no=<?php echo h($row2["temp_mrin_wip"]); ?>&&TB_iframe=true&height=400&width=800" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
