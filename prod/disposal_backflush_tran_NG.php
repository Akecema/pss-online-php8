            ...
            <tr>
			 ...
			 ?></td>
              ...
              <td><select name="doc_disposal_no" id="doc_disposal_no" class="span8">
                  ...
                  <?php
	             $query9 = "SELECT * FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND status_disposal = '".$rst_sta["status_desc"]."' GROUP BY doc_disposal_no";
...
echo "window.location='disposal_backflush_tran_NG2.php?date1=$dateF&&date2=$dateT&&doc_disposal_no=$doc_disposal_no'";
   ...
   $query8 = "SELECT * FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND status_disposal = '".$rst_sta["status_desc"]."' GROUP BY doc_disposal_no ORDER BY plan_no ASC";
   ...
   $pages->paginate();
	...
	$query = "SELECT *, DATE_FORMAT(date_plan,'%d-%m-%Y') as R, DATE_FORMAT(date_posting,'%d-%m-%Y') as R2 FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != ''  AND status_disposal = '".$rst_sta["status_desc"]."' GROUP BY doc_disposal_no ORDER BY plan_no ASC $pages->limit";
