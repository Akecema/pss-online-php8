...
/**
 * prod/disposal_backflush_tran_NG.php
 * Part of: Production module
 * Filename suggests: disposal backflush tran NG
 *
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_production.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">Production</a><a href="#"><b>Disposal</b></a></div>
  <h1>Disposal</h1>
</div>
        ...
        <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              <li class="active"><a  role="tab" href="disposal_backflush_tran_NG.php">New Disposal</a></li>
              <li><a role="tab" href="disposal_backflush_tran_NG_approved.php">Approved Disposal</a></li>
             </ul>
          </div>
          </div>
            ...
            <tr>
			 ...
			 ?></td>
              ...
              <td><select name="doc_disposal_no" id="doc_disposal_no" class="span8">
                  ...
                  <?php
	             $query9 = "SELECT * FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND status_disposal = ? GROUP BY doc_disposal_no"; $query9_args = [$rst_sta["status_desc"]];
...
<?php
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
echo "window.location='disposal_backflush_tran_NG2.php?date1=$dateF&&date2=$dateT&&doc_disposal_no=$doc_disposal_no'";
            echo "</script>";
   ...
   $query8 = "SELECT * FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND status_disposal = ? GROUP BY doc_disposal_no ORDER BY plan_no ASC"; $query8_args = [$rst_sta["status_desc"]];
   ...
   $pages->paginate();
	...
	$query = "SELECT *, DATE_FORMAT(date_plan,'%d-%m-%Y') as R, DATE_FORMAT(date_posting,'%d-%m-%Y') as R2 FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != ''  AND status_disposal = '".db_esc($dbc, $rst_sta["status_desc"])."' GROUP BY doc_disposal_no ORDER BY plan_no ASC $pages->limit";
   ...
   while ($row = mysqli_fetch_array($rs))
   {
      ...
      ?>  
              <tbody>
                ...
                <td width="93">
               <?php if($row["status_disposal"] == "New")
			   
			   { 
			       if($row["status_part"] == "PR")
				   {
				   ?> 
                <a value="Edit" href="edit_disposal_new_tran_NG.php?doc_disposal=<?php echo h($row["doc_disposal_no"]); ?>&&TB_iframe=true&height=400&width=1100" class="thickbox" target="_self"><img src="../img/edit.gif" alt="Edit">Edit</a>
                <?php 
				   }elseif($row["status_part"] == "WS"){
					?>   
				 <a value="Edit" href="edit_disposal_new_tran_NG_wastage.php?doc_disposal=<?php echo h($row["doc_disposal_no"]); ?>&&TB_iframe=true&height=400&width=1100" class="thickbox" target="_self"><img src="../img/edit.gif" alt="Edit">Edit</a>	   
                ...
                <?php
                 if($row["status_part"] == "PR")
				   {
					?>
              <a value="Cancel" href="cancel_disposal_allproc.php?doc_disposal=<?php echo h($row["doc_disposal_no"]); ?>&&TB_iframe=true&height=400&width=1100" class="thickbox" target="_self"><img src="../img/delete.png" width="16" height="16" alt="Cancel">Cancel</a>
              <?php
				   ...
				   
				   {
					...
					?> 
               <a value="Cancel" href="cancel_disposal_allproc_NG.php?doc_disposal=<?php echo h($row["doc_disposal_no"]); ?>&&TB_iframe=true&height=400&width=1100" class="thickbox" target="_self"><img src="../img/delete.png" width="16" height="16" alt="Cancel">Cancel</a>	              <?php }
