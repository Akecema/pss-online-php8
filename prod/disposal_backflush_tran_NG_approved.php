...
/**
 * prod/disposal_backflush_tran_NG_approved.php
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_production.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="#">Production</a> <a href="#"><b>Disposal</b></a></div>
  <h1>Disposal</h1>
</div>
...
echo "window.location='disposal_backflush_tran_NG2_approved.php?date1=$dateF&&date2=$dateT&&doc_disposal_no=$doc_disposal_no'";
   ...
   $query8 = "SELECT * FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND status_disposal != ? AND status_disposal != ? AND status_disposal != ? GROUP BY doc_disposal_no ORDER BY plan_no ASC"; $query8_args = [$rst_sta["status_desc"], $rst_sta16["status_desc"], $rst_sta4["status_desc"]];
   ...
   while ($row = mysqli_fetch_array($rs))
   {
      ...
      ?>  
              <tbody>
                ...
                <td width="158"><?php echo h($row["R3"]); ?></td>
