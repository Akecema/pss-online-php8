...
/**
 * prod/disposal_backflush_tran_approved_download.php
 * Part of: Production module
 * Filename suggests: disposal backflush tran approved download
 *
...
//-------Count all results------------------------//
  ...
  $query8 = "SELECT COUNT(*) FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND status_disposal != ?"; $query8_args = [$rst_sta4["status_desc"]];
...
$query = "SELECT *, DATE_FORMAT(date_plan,'%d-%m-%Y') as R, DATE_FORMAT(date_posting,'%d-%m-%Y') as R2, DATE_FORMAT(date_reject,'%d-%m-%Y') as R3, DATE_FORMAT(date_wastage,'%d-%m-%Y') as R4, DATE_FORMAT(date_disposal,'%d-%m-%Y') as R5, DATE_FORMAT(date_approve,'%d-%m-%Y') as R6, DATE_FORMAT(date_approve2,'%d-%m-%Y') as R7 FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND status_disposal != ? AND status_disposal != ? AND status_disposal != ? ORDER BY doc_disposal_no ASC"; $query_args = [$rst_sta["status_desc"], $rst_sta16["status_desc"], $rst_sta4["status_desc"]];
