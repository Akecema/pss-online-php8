...
<?php
		   ...
		   echo $row_convert["id_factory_pps"];*/
   ...
   $query8 = "SELECT COUNT(*) FROM pps_detail_transaction AS MR, work_center_detail AS SR WHERE MR.work_center = SR.id_work AND (MR.status_pps = '".$rst_sta7["status_desc"]."' OR MR.status_pps = '".$rst_sta14["status_desc"]."' OR MR.status_pps = '".$rst_sta4["status_desc"]."')".$where_sql;
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="doc_list_backflush_download_selected.php?date1=<?php echo $dateF; ?>&&date2=<?php echo $dateT; ?>&&factory=<?php echo $factory; ?>&&work_center=<?php echo $work_center; ?>&&plan_no=<?php echo $plan_no; ?>&&shift_ops=<?php echo $shift_ops; ?>" ><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
	...
	if($sta_out2 == "211")
	{
	 ...
	 // $status_output = "";
      ...
      ?>
                ...
                <td width="90"><font color="#0000CC"><?php echo $row[3]; ?></font><br><font color="#FF0000"><?php if ($row[40] != "") { echo $row[40]; } ?></font></td>
