...
/**
 * prod/document_list_backflush_tran2.php
 * Part of: Production module
 * Filename suggests: document list backflush tran2
 *
         ...
         <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              <li class="active"><a  role="tab" href="document_list_backflush_tran.php">Current</a></li>
              <li><a role="tab" href="document_list_backflush_tran_hist.php">History</a></li>
             </ul>
          </div>
          </div>
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="doc_list_backflush_download_selected.php?date1=<?php echo h($dateF); ?>&&date2=<?php echo h($dateT); ?>&&factory=<?php echo h($factory); ?>&&work_center=<?php echo h($work_center); ?>&&plan_no=<?php echo h($plan_no); ?>&&shift_ops=<?php echo h($shift_ops); ?>" ><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
	...
	if($sta_out2 == "211")
	{
	 ...
	 // $status_output = "";
      ...
      ?>
                ...
                <td width="90"><font color="#0000CC"><?php echo h($row[3]); ?></font><br><font color="#FF0000"><?php if ($row[40] != "") { echo h($row[40]); } ?></font></td>
