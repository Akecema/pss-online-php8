...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="doc_list_backflush_download_selected_hist.php?date1=<?php echo $dateF; ?>&&date2=<?php echo $dateT; ?>&&factory=<?php echo $factory; ?>&&work_center=<?php echo $work_center; ?>&&plan_no=<?php echo $plan_no; ?>&&shift_ops=<?php echo $shift_ops; ?>" ><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
	...
	if($sta_out2 == "211")
	{
	 ...
	 // $status_output = "";
      ...
      ?>
                ...
                <td width="48"><?php echo $row["time_posting"]; ?></td>
                ...
                <td width="90"><font color="#0000CC"><?php echo $row["bflush_no"]; ?></font><br><font color="#FF0000"><?php if ($row["bflush_no_ref"] != "") { echo $row["bflush_no_ref"]; } ?></font></td>
