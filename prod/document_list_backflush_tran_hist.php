...
/**
 * prod/document_list_backflush_tran_hist.php
...
echo "window.location='document_list_backflush_tran2_hist.php?date1=$dateF&&date2=$dateT&&factory=$factory&&work_center=$work_center&&plan_no=$plan_no&&shift_ops=$shift_ops'";
 ...
 // echo $end_date_check;
   ...
   $query8 = "SELECT COUNT(*) FROM pps_detail_transaction_v1 WHERE status_pps = ? AND (date_plan >= '$start_date_check' AND date_plan <= '$end_date_check')"; $query8_args = [$rst_sta7["status_desc"]];
