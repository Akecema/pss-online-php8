...
/**
 * prod/draft_request_wip.php
 * Part of: Production module
 * Filename suggests: draft request wip
 *
  ...
  <!--  <div class="span6">-->
    ...
    <table width="930">
          <tr>
            ...
            <td width="98%"><form name="frmSearch" method="get" action="draft_request_wip2.php">
              <table width="724">
                <tr>
...
echo '<font color="red" class ="error_entry">', $message, '</font>';
   ...
   $query8 = "SELECT COUNT(*) FROM wip_request AS MR, scan_detail_wip AS SD WHERE MR.id_scan_wip = SD.id_scan AND SD.status_urgent = 'N' AND MR.status_request = 'N' AND MR.user_create = ? AND ((MR.date_mrin >= '$current_date') AND (MR.date_mrin <= '$next_date')) ORDER BY MR.id_req_wip ASC"; $query8_args = [$res["user_no"]];
...
$query = "SELECT *, DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R FROM wip_request AS MR, scan_detail_wip AS SD WHERE MR.id_scan_wip = SD.id_scan AND SD.status_urgent = 'N' AND MR.status_request = 'N' AND MR.user_create = ? AND ((MR.date_mrin >= '$current_date') AND (MR.date_mrin <= '$next_date')) GROUP BY MR.id_scan_wip ORDER BY MR.id_req_wip ASC"; $query_args = [$res["user_no"]];
