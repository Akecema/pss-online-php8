...
/**
 * prod/draft_request_wip_urgent.php
 * Part of: Production module
 * Filename suggests: draft request wip urgent
 *
      ...
      <div class="widget-box">
        ...
        <table width="930">
          <tr>
            ...
            <td width="98%"><form name="frmSearch" method="get" action="draft_request_wip_urgent2.php">
              <table width="724">
                <tr>
...
echo '<font color="red" class ="error_entry">', $message, '</font>';
  ...
  $query8 = "SELECT COUNT(*) FROM wip_request AS MR, scan_detail_wip AS SD WHERE MR.id_scan_wip = SD.id_scan AND SD.status_urgent = 'Y' AND MR.status_request = 'N' AND MR.user_create = ? AND ((MR.date_mrin >= '$current_date') AND (MR.date_mrin <= '$next_date')) ORDER BY MR.id_req_wip ASC"; $query8_args = [$res["user_no"]];
...
?>
  ...
  <tr>
   <td><div align="center">
    ...
    <td>&nbsp;</td>
         ...
         <?php
	$query_again = "SELECT * FROM wip_request WHERE status_request = 'N' and id_scan_wip = ?"; $query_again_args = [$row2[6]];
  ...
  $row4_p = mysqli_fetch_array($result4_p); 
	 ...
	 <input name="bom_qty[<?php echo $i; ?>]" type="text" value="<?php if(isset($_POST["bom_qty"])) { echo h($_POST["bom_qty"][$i]); }else{  echo h($row["bom_qty_wip"]);   } ?>" class="span8" />&nbsp;</div></td>
