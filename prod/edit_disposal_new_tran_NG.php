...
/**
 * prod/edit_disposal_new_tran_NG.php
 * Part of: Production module
 * Filename suggests: edit disposal new tran NG
 *
  ...
  <tr>
    ...
    <table width="98%"  class="table table-bordered">
      ...
      <!-- Content -->
              ...
              <!-- End Box Head -->
          <form name="myform" action="edit_disposal_new_tran_NG.php?doc_disposal=<?php echo h($doc_disposal); ?>" method="post" >
            <!-- Form -->
            <div class="form">
