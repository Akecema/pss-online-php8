...
$query_update = "UPDATE material_request SET bom_qty = ?, user_update = ?, date_update = NOW() WHERE id_req = ? "; $query_update_args = [$_POST["bom_qty"][$i], $data_u["user_no"], $_POST["id_req"][$i]];
