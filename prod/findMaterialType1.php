...
$query9 = "SELECT DISTINCT material_no, material_desc FROM table_material WHERE mat_type = '".db_esc($dbc, $material_type)."' AND bom_status = 'Y' ORDER BY material_no ASC";
