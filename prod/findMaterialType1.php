...
$query9 = "SELECT DISTINCT material_no, material_desc FROM table_material WHERE mat_type = ? AND bom_status = 'Y' ORDER BY material_no ASC"; $query9_args = [$material_type];
...
<body>
   ...
   <option value="NULL" placeholder="Select Part No."> -- Select Part No. --</option>
    ...
    ?>
    <option value="<?php echo h($row9["material_no"]); ?>" > <?php echo h($row9["material_no"]); ?> - <?php echo h($row9["material_desc"]); ?></option>
