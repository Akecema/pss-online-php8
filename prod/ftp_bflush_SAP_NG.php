...
while($row = mysql_fetch_array($qry)) {
	...
	$result_iscanA = mysql_query($query_iscanA);
	$row_iscanA = mysql_fetch_array($result_iscanA);
...
file_put_contents($file,$data);
  ...
  $data_collect = mysql_fetch_array($rst_collect);
	...
	$result_iscanA2 = mysql_query($query_iscanA2);
	$row_iscanA2 = mysql_fetch_array($result_iscanA2);
