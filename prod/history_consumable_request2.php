...
/**
 * prod/history_consumable_request2.php
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
    ...
    $query8 = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR, consumable_detail AS SD WHERE MR.id_con = SD.id_con AND MR.status_request = 'Y' AND MR.status_print = 'Y' ".$where_sql." GROUP BY MR.temp_mrin"; $query8_args = [...$where_args];
...
$query = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR, consumable_detail AS SD WHERE MR.id_con = SD.id_con AND MR.status_request = 'Y' AND MR.status_print = 'Y' ".$where_sql." GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC, MR.temp_mrin ASC "; $query_args = [...$where_args];
...
?>
  ...
  <tr>
    ...
    <td width="60"><a href="detail_consumable_request_reprinting.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&amp;&amp;TB_iframe=true&amp;height=400&amp;width=800" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print" />Print</a> </td>
  </tr>
