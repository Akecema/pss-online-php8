...
$query_plan_req = "SELECT * FROM pps_detail WHERE status_pps = ? ORDER BY date_plan DESC"; $query_plan_req_args = [$rst_sta7["status_desc"]];
...
$query_release_req = "SELECT * FROM pps_detail WHERE status_pps = ? ORDER BY date_plan DESC"; $query_release_req_args = [$rst_sta2["status_desc"]];
...
$query_disposal_req = "SELECT * FROM reject_detail_disposal WHERE status_disposal = ? AND (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' GROUP BY doc_disposal_no ORDER BY date_plan DESC"; $query_disposal_req_args = [$rst_sta["status_desc"]];
...
// approved disposal
$query_disposal_req_app = "SELECT * FROM reject_detail_disposal WHERE status_disposal != ? AND status_disposal != ? AND (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' GROUP BY doc_disposal_no ORDER BY date_plan DESC"; $query_disposal_req_app_args = [$rst_sta["status_desc"], $rst_sta16["status_desc"]];
