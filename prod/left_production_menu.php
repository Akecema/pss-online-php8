<?php
/**
 * prod/left_production_menu.php
 * Part of: Production module
 * Filename suggests: left production menu
 *
  ...
  <ul>
   ...
   <?php
      ...
      <ul>
        ...
        <li class="submenu active active"><?php }else { echo "<li>"; } ?><a href="material_consumable_request.php">Consumable Request <font color="#FF9900"> [<?php  echo h($num_rows); ?>] </font></a></li>
