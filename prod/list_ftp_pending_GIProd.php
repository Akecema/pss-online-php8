...
/**
 * prod/list_ftp_pending_GIProd.php
 * Part of: Production module
 * Filename suggests: list ftp pending GIProd
 *
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_production.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="#">FTP Monitoring</a> <a href="#" class="current">FTP Monitoring</a></div>
  <h1>FTP Monitoring</h1>
</div>
         ...
         <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              <li><a  role="tab" href="list_ftp_pending_sap.php">Backflush</a></li>
              <li class="active"><a role="tab" href="list_ftp_pending_GIProd.php">Goods Issue</a></li>
             </ul>
          </div>
          </div>
...
//   opendir($_SERVER['DOCUMENT_ROOT'] . "../../PSS_Online/FromPortal2/GI/") or die(...)
...
if(is_dir($dir)){
  ...
  // $total2 = count($dh); removed - count() on a directory resource/handle throws a fatal TypeError under PHP 8 (was PHP7: warning + returned 1). $total2 was assigned but never read anywhere in this file, so the line was just dropped rather than wrapped.
   ...
   echo "<br>";
   echo "<font color='blue'>TOTAL FILES : ".h($total)." </font>"; echo "<br>";
 ...
 ?>
  ...
  <table class="table">
   ...
   <?php
    ...
    <table class="table">
    <tr>
    <td colspan="6"><b><font color = 'blue'>
	
	<?php echo h($filename2); ?></font></b>
	...
	$query = "SELECT *, DATE_FORMAT(posting_date,'%d-%m-%Y') AS R2 FROM ftp_approval_qc WHERE file_name = ? AND status_ftp = 'Y'"; $query_args = [$filename2];
