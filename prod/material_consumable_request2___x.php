...
/**
 * prod/material_consumable_request2___x.php
 * Part of: Production module
 * Filename suggests: material consumable request2 x
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, consumable_detail, consumable_request, work_center_detail.
...
?>
     <!-- Box -->
        ...
        <form name="form2" method="post" action="material_consumable_request2.php?material_no=<?php echo $material_no; ?>&&lastID=<?php echo $lastID; ?>&&con_qty=<?php echo $con_qty; ?>&&date1=<?php echo h($date1); ?>&&t_time=<?php echo h($t_time); ?>&&factory=<?php echo h($factory); ?>&&work_center=<?php echo $work_center; ?>">
             <?php
