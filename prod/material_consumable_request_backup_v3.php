...
/**
 * prod/material_consumable_request_backup_v3.php
 * Part of: Production module
 * Filename suggests: material consumable request backup v3
 *
...
$('#Bname').change(function() {
    ...
    $('input[name=mat]').val( selectedOption.data('material_no') );
    $('input[name=mat_des]').val( selectedOption.data('mat_desc') );
...
function updateTextBox() {
    ...
    var status = orderStatusSelect.options[orderStatusSelect.selectedIndex].value;
 ...
 // $status_1 = status;
  ...
  $query_unit = "SELECT * FROM consumable_detail";
...
//insert to scan_detail
$query_db = "INSERT INTO `consumable_request` (id_req_con, mrin_doc, mrin_year, temp_mrin, id_con, id_scan, material_no, con_qty, con_uom, status_request, status_print, status_view, factory, user_create, date_create, user_update, date_update, date_posting, time_posting, status, date_require, time_require, id_work) VALUES ('".mysqli_insert_id($dbc)."', '$number', '$year','$ref', '$material_no', '$lastID','".$row_data["material_no"]."', '$con_qty', '".$row_data["BUn"]."', 'Y', 'N','N','$factory', '$user_no', NOW(),'','',NOW(),NOW(),'New','$date1','$t_time','$work_center')";
$result = mysqli_query($dbc, $query_db) or die (mysqli_error($dbc));
...
*</font></td>
               ...
               <tr>
                ...
                <td height="35">:</td>
                <td height="35" colspan="5"><select name="material_no" id="material_no" onclick="updateTextBox();">
              ...
              <tr>
                ...
                <td height="35">:</td>
                <td height="35" colspan="5"><input name="con_qty" type="text" value="<?php if(isset($_POST["con_qty"])) { echo $_POST["con_qty"]; } ?>" size="10"/>
                <font color="#006699">*</font>
                </td>
              </tr>
              <tr>
