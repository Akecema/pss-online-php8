...
/**
 * prod/material_master_list2.php
 * Part of: Production module
 * Filename suggests: material master list2
 *
...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM mat_master_header WHERE (material_no LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' or bom LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' ) AND status_BOM = 'Y'";
...
$query = "SELECT * FROM mat_master_header WHERE (material_no LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' or bom LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' ) AND status_BOM = 'Y' ORDER BY material_no ASC";
...
?>
   ...
   while ($row2 = mysqli_fetch_array($rs))
   {
      ...
      ?>
                ...
                <!--<td>&nbsp; <a value="Edit" href="material_master_edit.php?id_hdr=<?php echo h($row2["id_hdr"]); ?>&amp;&amp;TB_iframe=true&amp;height=400&amp;width=700" class="thickbox" target="_self"> <img src="../img/edit.gif" width="16" height="16" alt="Edit" />Edit</a></td>-->
                </tr>
