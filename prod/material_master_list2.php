...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM mat_master_header WHERE (material_no LIKE ? or bom LIKE ? ) AND status_BOM = 'Y'"; $query8_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
...
$query = "SELECT * FROM mat_master_header WHERE (material_no LIKE ? or bom LIKE ? ) AND status_BOM = 'Y' ORDER BY material_no ASC"; $query_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
