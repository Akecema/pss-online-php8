...
<div id="content">
 <div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM mat_master_header WHERE (material_no LIKE '%".$_GET["txtKeyword"]."%' or bom LIKE '%".$_GET["txtKeyword"]."%' ) AND status_BOM = 'Y'";
...
$query = "SELECT * FROM mat_master_header WHERE (material_no LIKE '%".$_GET["txtKeyword"]."%' or bom LIKE '%".$_GET["txtKeyword"]."%' ) AND status_BOM = 'Y' ORDER BY material_no ASC";
