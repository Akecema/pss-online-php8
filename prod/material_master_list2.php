...
?>
   ...
   while ($row2 = mysqli_fetch_array($rs))
   {
      ...
      ?>
                ...
                <!--<td>&nbsp; <a value="Edit" href="material_master_edit.php?id_hdr=<?php echo $row2["id_hdr"]; ?>&amp;&amp;TB_iframe=true&amp;height=400&amp;width=700" class="thickbox" target="_self"> <img src="../img/edit.gif" width="16" height="16" alt="Edit" />Edit</a></td>-->
                </tr>
