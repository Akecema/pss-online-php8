...
$query_db = "INSERT INTO `scan_detail` (id_scan, pps_ref, factory, work_center, prod_order, material_no, scan_oum, scan_plant, scan_sloc, scan_qty, user_create, date_create, user_update, date_update, status_urgent) VALUES ('".mysql_insert_id()."', '', '$factory', '$work_center', '$prod_order', '$material_no', '', '', '$factory', '', '$user_no', NOW(),'','','Y')";
$result = mysql_query($query_db) or die (mysql_error());
			 ...
			 $query_sql = "SELECT * FROM `scan_detail` WHERE id_scan = '".mysql_insert_id()."'";
