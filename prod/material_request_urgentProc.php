...
onClick="Check(document.myform.cancel)">  </div></td>
               ...
               <td><input name="comp_quantity[<?php echo h($row["id_dtl"]); ?>]" type="text" value="<?php if(isset($_POST["comp_quantity"])) { echo $_POST["comp_quantity"][($row["id_dtl"])]; }else{  echo $num_convert;   } ?>" /></td>
