...
$data_u = mysqli_fetch_array($result_u);   //how many records are there?   
    ...
    <td width="74"><?php echo $row_scan["work_center"]; ?></td>
...
elseif($curr_time >= $plus_20)
{
	...
	?>
              ...
              <td width="48"><a value="Details" href="detail_material_request.php?mrin_no=<?php echo $row2["temp_mrin"]; ?>&&TB_iframe=true&&height=400&&width=800" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
  <td width="55"><a href="detail_material_request_printing.php?mrin_no=<?php echo $row2["temp_mrin"]; ?>&&TB_iframe=true&&height=400&&width=800" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
