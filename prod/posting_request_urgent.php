...
/**
 * prod/posting_request_urgent.php
 * Part of: Production module
 * Filename suggests: posting request urgent
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, factory_detail, material_request, scan_detail.
...
<div class="container-fluid">
  ...
  <!--  <div class="span6">-->
   ...
   <?php
        ...
        echo "<script>";
		echo "window.location='posting_request_urgent2.php?temp_mrin=$temp_mrin&&prod_order=$prod_order&&date1=$dateF&&date2=$dateT&&work_center=$work_center&&factory=$factory'";
