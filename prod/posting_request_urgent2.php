...
/**
 * prod/posting_request_urgent2.php
 * Part of: Production module
 * Filename suggests: posting request urgent2
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, sys_setup_maintain, factory_detail, work_center_detail, material_request, scan_detail.
  ...
  <!--  <div class="span6">-->
          ...
          <div class="widget-title">
            <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="posting_request_urgent.php">Posting Request</a></li>
            </ul>
          </div>
          </div>
         <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
            <h5>Posting Request</h5>
          </div>
...
?>
   ...
   $query_scan = "SELECT * FROM scan_detail WHERE id_scan = ?"; $query_scan_args = [$row2["id_scan"]];
...
$data_u = mysqli_fetch_array($result_u);   //how many records are there?   
    ...
    <td width="74"><?php echo h($row_scan["work_center"]); ?></td>
...
if ($curr_time < $min_20)
{
                echo '<td><div align="center"><img src="../img/grey_icon.jpg" width="25" height="25" /></div></td>';
}
elseif(($curr_time >= $min_20) && ($curr_time < $request_time) )
{
                echo '<td><div align="center"><img src="../img/green_icon2.jpg" width="25" height="25" /></div></td>';
}
...
elseif($curr_time >= $plus_20)
{
	...
	?>
              ...
              <td width="48"><a value="Details" href="detail_material_request.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&TB_iframe=true&&height=400&&width=800" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
  <td width="55"><a href="detail_material_request_printing.php?mrin_no=<?php echo h($row2["temp_mrin"]); ?>&&TB_iframe=true&&height=400&&width=800" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
