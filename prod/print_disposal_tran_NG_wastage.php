...
/**
 * prod/print_disposal_tran_NG_wastage.php
...
@media print{
 ...
 a[href]:after {
  ...
  .page {
    ...
    .pagenum:before { "Page " counter(page) " of " counter(pages); }
}
...
<table width="98%" border="0" cellpadding="2">
  <tr>
   <td width="35%" valign="top"><img src="../set_upload/<?php echo h($filename);  ?>"width="267" height="27"/>
