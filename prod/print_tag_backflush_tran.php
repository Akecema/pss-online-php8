   ...
   while ($row = mysqli_fetch_array($rs))
   {
	...
	}elseif($sta_out == "3")
	{
      ...
      ?>
                ...
                <td width="99"><a value="Print Tag" href="display_tag_backflush_ts.php?uid=<?php echo $row["id"]; ?>&&TB_iframe=true&height=600&width=1000" class="thickbox" target="_self"><img src="../img/tag.png" width="16" height="16" alt="Print Tag">Print Tag</a></td>
                </tr>
