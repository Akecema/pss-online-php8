...
/**
 * prod/report_prod.php
 * Part of: Production module
 * Filename suggests: report prod
 *
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
            ...
            <tr>
              <th>Material No :</th>
              <td><input name="material_no" type="text" id="material_no" size="25" class="span11" /></td>
 ...
 <?php
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
            echo "window.location='report_prodProc.php?material_no=$material_no&&prod_order=$prod_order&&date1=$dateF&&date2=$dateT&&work_center=$work_center&&factory=$factory'";
            echo "</script>";
