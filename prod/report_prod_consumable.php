...
/**
 * prod/report_prod_consumable.php
 * Part of: Production module
 * Filename suggests: report prod consumable
 *
  ...
  <div class="row-fluid">
      ...
      <?php
        if(isset($_POST["Submit"]))
        {
            ...
            echo "<script>";
            echo "window.location='report_prod_consumableProc.php?material_no=$material_no&&date1=$dateF&&date2=$dateT&&factory=$factory'";
            echo "</script>";
