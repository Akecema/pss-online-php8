              ...
              <tr>
                ...
                <select name="docF" id="docF">
                  ...
                  <?php
						...
						{
						?>
                  <option value="<?php echo $rowd['doc_disposal_no']?>" <?php if($rowd["doc_disposal_no"] == $_GET["docF"]) echo "selected"; ?> ><?php echo $rowd['doc_disposal_no']?></option>
                  <?php
						}
					  ?>
                </select>
               ...
               <select name="docT" id="docT">
                  ...
                  <?php
					...
					{
					?>
                  <option value="<?php echo $rowd2['doc_disposal_no']?>" <?php if($rowd2["doc_disposal_no"] == $_GET["docT"]) echo "selected"; ?>> <?php echo $rowd2['doc_disposal_no']?></option>
                  <?php
						}
					  ?>
                </select></td>
