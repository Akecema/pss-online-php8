...
<div id="content-header">
  ...
  <div class="container-fluid">
	...
	$query_convert = "SELECT * FROM `work_center_detail` WHERE id_factory = '".db_esc($dbc, $_GET["factory"])."' ";
	...
	$query = "SELECT *, DATE_FORMAT(MR.date_wastage,'%d-%m-%Y  %H:%i:%s') as R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') as R2 FROM reject_detail_disposal AS MR, work_center_detail AS SR WHERE SR.id_work = MR.work_center AND MR.status_part = 'WS' AND MR.qty_wastage != '' AND MR.doc_disposal_no != '' ".$where_sql." ORDER BY MR.plan_no ASC";
