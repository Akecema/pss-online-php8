...
<!-- Container -->
<div id="container"> 
 <div class="small-nav"> User Maintenance&nbsp;&gt;Display Account &nbsp;&gt;Edit</div>
  <div class="shell">
     <!-- Small Nav -->
...
echo "window.location='detail_user.php?user_no=$user_no;'"; 
echo "</script>"; 
//echo 'ok'; 
exit(); 
...
{ echo '<div class="msg msg-error"><font color="red" class ="error_entry">', $message, '</font></div>';
 ...
 ?> 
        ...
        <div class="box">
          ...
          <!-- End Box Head -->
          <form name="form1" method="post" action="user_edit.php?user_no=<?php echo mb_rawurlencode($user_no); ?>" >
  ...
  $row4_p = mysqli_fetch_array($result4_p);
 	...
 	echo ' <select name="level_id" class="title">
