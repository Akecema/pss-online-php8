...
/**
 * prod/wip_request_analysisProc.php
...
<div id="content">
 <div id="content-header" class="noprint">
  <div id="breadcrumb"> <a href="index_production.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">WIP Request</a> <a href="#" class="current">WIP Request Report</a> </div>
  <h1>WIP Request</h1>
</div>
...
//------------------------------------------------------------------------------------------------------------------	
  ...
  <tr>
    ...
    <td width="90"><div align="right"><?php echo h($row2["bom_qty_wip"]); ?></div> </td>
