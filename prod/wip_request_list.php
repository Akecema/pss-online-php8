...
//print_r(explode('|', $str, -1));
                   ...
                   $query3 = "SELECT * FROM factory_detail WHERE id_fac = ? ORDER BY id_fac ASC"; $query3_args = [$part5];
                   $result3 = db_query_bind($dbc, $query3, $query3_args);
				   $row3 = mysqli_fetch_array($result3, MYSQLI_NUM); 
				   
 
//insert to scan_detail
$query_db = "INSERT INTO `scan_detail_wip` (id_scan, pps_ref, factory, work_center, prod_order, material_no, scan_oum, scan_plant, scan_sloc, scan_qty, user_create, date_create, user_update, date_update, status_urgent) VALUES ('".mysqli_insert_id($dbc)."', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(),'','','N')"; $query_db_args = [$pps_ref2, $row3[2], $part7, $part1, $part2, $part3, $part4, $part5, $part6, $user_no];
