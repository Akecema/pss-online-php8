...
$result = mysqli_query($dbc, $query_db) or die (mysqli_error($dbc));
	...
	$query_update = "UPDATE `scan_detail_wip` SET scan_oum = '".db_esc($dbc, $data_sql2["BUn"])."', scan_plant = '".db_esc($dbc, $data_sql2["plant"])."' WHERE id_scan = '".db_esc($dbc, $data_sql["id_scan"])."'";
