...
/**
 * prod_super/FTP_gdtranfer_download.php
 * Part of: Production module (supervisor/admin tier)
 * Filename suggests: FTP gdtranfer download
 *
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_production_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">FTP Monitoring</a> <a href="#" class="current">FTP Good Transfer</a> </div>
  ...
  <div class="container-fluid">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="frmSearch" id="frmSearch">
         <table class="table table-bordered table-striped">
              <tr>
                  <th height="56">Posting Date From :</th>
                  <td><?php
        ...
        if(isset($_POST["Submit"]))
        {
			...
			echo "<script>";
			echo "window.location='FTP_gdtranfer_downloadProc.php?date1=$dateF&&date2=$dateT'";
			echo "</script>";
