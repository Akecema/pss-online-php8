...
/**
 * prod_super/approval_disposal_qc_new_tran_NG.php
    ...
    <td width="38%"><table width="98%" border="0" cellpadding="2">
      ...
      <!-- Content -->
          <!-- Form -->
            <div class="form">
              <!-- End Box Head -->
          <form name="myform" action="approval_disposal_qc_new_tran_NG.php?doc_disposal=<?php echo $doc_disposal; ?>" method="post" >
