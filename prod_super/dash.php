...
$query_disposal_req = "SELECT COUNT(*) AS cnt FROM reject_detail_disposal WHERE status_disposal = '".db_esc($dbc, $rst_sta["status_desc"])."' AND (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != ''";
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
       <ul class="quick-actions">
        <li class="bg_lb"> <a href="posting_request_all_screen_LCD.php"> <i class="icon-exchange"></i> <span class="label label-important"><?php echo $num_mat_req;   ?></span> Open <br>Material Request </a> </li>
        <li class="bg_ls"> <a href="posting_request_all_screen_LCD_consumable.php"> <i class="icon-barcode"></i><span class="label label-important"><?php echo $num_con_req;   ?></span> Open <br>Consumable Request</a> </li>
        <li class="bg_ly"> <a href="disposal_backflush_tran_NG.php"> <i class="icon-bar-chart"></i><span class="label label-important"><?php echo $num_disposal_req;   ?></span>Pending <br>Approval Disposal</a> </li>
