 ...
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, login_detail, material_request, consumable_request, wip_request, reject_detail_disposal, pps_detail_transaction.
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index_production_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
<!--End-breadcrumbs-->
<?php 
...
$query_disposal_req = "SELECT COUNT(*) AS cnt FROM reject_detail_disposal WHERE status_disposal = ? AND (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != ''"; $query_disposal_req_args = [$rst_sta["status_desc"]];
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
       <ul class="quick-actions">
        <li class="bg_lb"> <a href="posting_request_all_screen_LCD.php"> <i class="icon-exchange"></i> <span class="label label-important"><?php echo h($num_mat_req);   ?></span> Open <br>Material Request </a> </li>
        <li class="bg_ls"> <a href="posting_request_all_screen_LCD_consumable.php"> <i class="icon-barcode"></i><span class="label label-important"><?php echo h($num_con_req);   ?></span> Open <br>Consumable Request</a> </li>
        <li class="bg_ly"> <a href="disposal_backflush_tran_NG.php"> <i class="icon-bar-chart"></i><span class="label label-important"><?php echo h($num_disposal_req);   ?></span>Pending <br>Approval Disposal</a> </li>
