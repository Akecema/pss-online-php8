...
/**
 * prod_super/detail_consumable_request.php
 * Part of: Production module (supervisor/admin tier)
 * Filename suggests: detail consumable request
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, sys_setup_maintain, consumable_request, factory_detail, work_center_detail, material_request_cancel, reason_req_cancel, material_request_close, reason_req_close.
...
$row_k2 = mysqli_fetch_array($result_k2);
    ...
    $query_u2 = "SELECT * FROM user_detail WHERE user_no = ?"; $query_u2_args = [$data_2['user_update']];
	$result_u2 = db_query_bind($dbc, $query_u2, $query_u2_args);   //run the query.
  ...
  <td colspan="2"><div align="center"><span class="style4">MRIN LIST</span></div></td>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <th>:</th>
          <th><?php echo h($data_u2["user_fullname"]); ?></th>
        </tr>
      </table>
  ...
  //------------------cost center --------------------//
   ...
   $row_cost_center = mysqli_fetch_array($result_cost_center);
	...
	?>
        ...
        <tr><td width="73" height="28"><?php  echo h($row["material_no"]); ?></td>
        <td width="200" height="28"><?php  echo h($row["mat_desc"]); ?></td>
        <td width="100" height="28"><div align="right"><?php echo h($row["con_qty"]); ?>&nbsp;</div></td>
	    ...
	    <td width="80">
	      <div align="center"><?php echo h($row_cost_center["cost_center"]); ?></div></td>
	    <td width="200">
                    <?php
...
?> &nbsp;   </td></tr>
	...
	$query_display_reason = "SELECT * from `material_request_cancel` WHERE temp_mrin = ? AND status = 'Cancel'"; $query_display_reason_args = [$temp_mrin];
...
<?php
	...
	$query_display_reason2 = "SELECT * from `material_request_close` WHERE temp_mrin = ? AND status = 'Close'"; $query_display_reason2_args = [$temp_mrin];
