...
<tr>
 ...
 $no = sprintf('%03d', $no);
   ...
   $query_scan = "SELECT * FROM scan_detail_wip WHERE id_scan = '".db_esc($dbc, $row["id_scan_wip"])."'";
   $result_scan = mysqli_query($dbc, $query_scan);
   $row_scan = mysqli_fetch_array($result_scan);

		 
   $query1_p = "SELECT * FROM scan_detail_wip WHERE id_scan = '".db_esc($dbc, $row["id_scan_wip"])."' GROUP BY id_scan";
