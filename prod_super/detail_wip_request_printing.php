...
<tr>
 ...
 $no = sprintf('%03d', $no);
   ...
   $query_scan = "SELECT * FROM scan_detail_wip WHERE id_scan = ?"; $query_scan_args = [$row["id_scan_wip"]];
   $result_scan = db_query_bind($dbc, $query_scan, $query_scan_args);
   $row_scan = mysqli_fetch_array($result_scan);

		 
   $query1_p = "SELECT * FROM scan_detail_wip WHERE id_scan = ? GROUP BY id_scan"; $query1_p_args = [$row["id_scan_wip"]];
