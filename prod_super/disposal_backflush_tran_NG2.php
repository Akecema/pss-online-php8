...
<div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT * FROM reject_detail_disposal AS MR WHERE (MR.status_part = 'PR' OR MR.status_part = 'WS') AND MR.doc_disposal_no != '' AND status_disposal = '".db_esc($dbc, $rst_sta["status_desc"])."'".$where_sql;
