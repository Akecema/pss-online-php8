...
echo "window.location='disposal_backflush_tran_NG2_approved.php?date1=$dateF&&date2=$dateT&&doc_disposal_no=$doc_disposal_no'";
   ...
   $query8 = "SELECT * FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND (status_disposal = '".$rst_sta3["status_desc"]."' OR status_disposal = '".$rst_sta17["status_desc"]."' OR status_disposal = '".$rst_sta4["status_desc"]."') GROUP BY doc_disposal_no ORDER BY plan_no ASC";
...
$query = "SELECT *, DATE_FORMAT(date_plan,'%d-%m-%Y') as R, DATE_FORMAT(date_posting,'%d-%m-%Y') as R2 FROM reject_detail_disposal WHERE (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' AND (status_disposal = '".$rst_sta3["status_desc"]."' OR status_disposal = '".$rst_sta17["status_desc"]."' OR status_disposal = '".$rst_sta4["status_desc"]."') GROUP BY doc_disposal_no ORDER BY plan_no ASC $pages->limit";
