...
//count how many data
  ...
  while ($row2 = mysqli_fetch_array($rs))
   ...
   $query_display = "SELECT *, DATE_FORMAT(MR.date_plan,'%d-%m-%Y') as RR, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') as RR2, DATE_FORMAT(MR.date_create,'%d-%m-%Y') as RR3 FROM pps_detail_transaction_v1 AS MR WHERE MR.pps_id = '".db_esc($dbc, $row2["id"])."'";
