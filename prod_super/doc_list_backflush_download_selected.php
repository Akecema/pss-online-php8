...
/**
 * prod_super/doc_list_backflush_download_selected.php
...
$namaFile = "Backflush Document List_".$date_tdy2.".xls";
 //convert material no kpd id_hdr
    ...
    $query8 = "SELECT * FROM pps_detail_transaction AS MR, work_center_detail AS SR WHERE MR.work_center = SR.id_work AND (MR.status_pps = ? OR MR.status_pps = ? OR MR.status_pps = ?)".$where_sql; $query8_args = [$rst_sta7["status_desc"], $rst_sta14["status_desc"], $rst_sta4["status_desc"], ...$where_args];
