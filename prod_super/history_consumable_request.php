...
/**
 * prod_super/history_consumable_request.php
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
    ...
    $query8 = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR, consumable_detail AS SD WHERE MR.id_con = SD.id_con AND MR.status_request = 'Y' AND MR.status_print = 'Y' GROUP BY MR.temp_mrin";
...
$query = "SELECT *, DATE_FORMAT(MR.date_require,'%d-%m-%Y') AS R FROM consumable_request AS MR, consumable_detail AS SD WHERE MR.id_con = SD.id_con AND MR.status_request = 'Y' AND MR.status_print = 'Y' GROUP BY MR.temp_mrin ORDER BY MR.date_posting ASC, MR.temp_mrin ASC ";
...
?>
   ...
   while ($row2 = mysqli_fetch_array($rs))
   {
    ...
    $query_u2 = "SELECT * FROM user_detail WHERE user_no = ?"; $query_u2_args = [$row2['user_update']];
