...
$query = "SELECT * FROM mat_master_header WHERE status_BOM = 'N' AND (material_no LIKE ? OR bom LIKE ?) ORDER BY material_no ASC"; $query_args = ['%' . $_GET["txtKeyword"] . '%', '%' . $_GET["txtKeyword"] . '%'];
