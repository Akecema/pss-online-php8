...
/**
 * prod_super/material_master_list2_NA.php
...
$query = "SELECT * FROM mat_master_header WHERE status_BOM = 'N' AND (material_no LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%' OR bom LIKE '%".db_esc($dbc, $_GET["txtKeyword"])."%') ORDER BY material_no ASC";
