...
/**
 * prod_super/report_production_reject.php
 * Part of: Production module (supervisor/admin tier)
 * Filename suggests: report production reject
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, factory_detail, reject_detail_disposal, type_reject_detail, reason_ng_reject, mat_master_header.
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_production_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="#">Production</a> <a href="#" class="current">Report Production Reject</a></div>
...
<?php
        if(isset($_POST["Submit2"]))
        {
            ...
            echo "<script>";
			echo "window.location='report_production_reject2.php?date1=$dateF&&date2=$dateT&&factory=$factory&&work_center=$work_center'";
            echo "</script>";
 ...
 // echo $end_date_check;
   ...
   $query8 = "SELECT COUNT(*) FROM reject_detail_disposal WHERE status_part = 'PR' AND qty_NG != '' AND doc_disposal_no != '' AND (date_posting >= '$start_date_check' AND date_posting <= '$end_date_check')";
...
$query = "SELECT *, DATE_FORMAT(date_reject,'%d-%m-%Y %H:%i:%s') as R FROM reject_detail_disposal WHERE status_part = 'PR' AND qty_NG != '' AND doc_disposal_no != '' AND (date_plan >= '$start_date_check' AND date_plan <= '$end_date_check') ORDER BY plan_no ASC";
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_production_reject_download_all.php" ><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
