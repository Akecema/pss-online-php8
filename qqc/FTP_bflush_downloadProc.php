...
/**
 * qqc/FTP_bflush_downloadProc.php
 ...
 * Includes: config.php, paginator.class2.php, tc_calendar.php, top_modal_menu.php, left_qqc_menu.php, ]., ]);
...
<div id="content">
 <div id="content-header" class="noprint">
  <div id="breadcrumb"> <a href="index_qqc.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">QC FTP Monitor</a> <a href="#" class="current">FTP Backflush</a> </div>
  <h1>FTP Backflush</h1>
</div>
