...
/**
 * qqc/FTP_gdtranfer_download.php
...
<div id="content">
 <div id="content-header">
  <div id="breadcrumb"> <a href="index_qqc.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">QC FTP Monitor</a> <a href="#" class="current">FTP Good Transfer</a> </div>
