...
$message = NULL; // create an empty new variable.
	...
	$data2 = "";
  		...
  		$query_ftp = "SELECT *, DATE_FORMAT(M.date_plan,'%d-%m-%Y') as J, DATE_FORMAT(M.date_cancel,'%d-%m-%Y') as J2, DATE_FORMAT(M.date_cancel,'%H:%i:%s') as J3 FROM qqc_transaction AS M WHERE M.id_qqc = ?"; $query_ftp_args = [$cancel[$i]];
...
<p>&nbsp;</p> 
   <form action="cancel_qc_rework_output.php?uid=<?php echo h($uid); ?>" method="post" name="myform" id="myform">     
...
$query_display = "SELECT *, DATE_FORMAT(MR.date_qc_posting,'%d-%m-%Y') as R2 FROM qqc_transaction AS MR WHERE MR.id_tran = ? AND status_QC != ?"; $query_display_args = [$uid, $rst_sta4["status_desc"]];
