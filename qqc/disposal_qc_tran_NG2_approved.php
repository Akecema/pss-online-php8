...
<tr>
    <td width="1%">&nbsp;</td> 
      <td>&nbsp;</td>
      <td width="7%"><a href="disposal_qc_tran_approved_download_selected.php?date1=<?php echo $dateF; ?>&&date2=<?php echo $dateT; ?>&&doc_disposal_no=<?php echo $doc_disposal_no; ?>" ><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
