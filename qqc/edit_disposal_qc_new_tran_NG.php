...
/**
 * qqc/edit_disposal_qc_new_tran_NG.php
 * Part of: QQC module (Quality)
 * Filename suggests: edit disposal qc new tran NG
 *
    ...
    <td width="38%"><table width="98%" class="table table-bordered">
      ...
      <tr>
        ...
        <td><?php echo $row_disposal["status_disposal"];  ?></td>
           ...
           <div class="form">
              <!-- End Box Head -->
          <form name="myform" action="edit_disposal_qc_new_tran_NG.php?doc_disposal=<?php echo h($doc_disposal); ?>" method="post" >
            <!-- Form -->
...
onClick="Check(document.myform.cancel)"> <?php  echo $row["id_disposal"]; ?></td>
  ...
  <table width="1100">
         ...
         <input type="submit" onClick="return confirm('Are you sure you want to edit this disposal? : <?php echo h($doc_disposal); ?>?');" name="Submit2" id="button" value="Save" class="btn btn-success"/></th>
