...
/**
 * qqc/list_ftp_pending2_NG_sap.php
 * Part of: QQC module (Quality)
 * Filename suggests: list ftp pending2 NG sap
 *
 * Behavior: requires an active login session ($_SESSION['username']).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, ftp_goodtran_detail, table_material.
         ...
         <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a  role="tab" href="list_ftp_pending2_NG_sap.php">Rework NG</a></li>
...
$path = "../../PSS_Online/FromPortal2/MT7/"; 

// Open the folder
 $dir_handle = @opendir($root . $path) or die("Unable to open $path");

$dir = "$root/FromPortal2/MT7/";

$folder = '../../PSS_Online/FromPortal2/MT7/';
$filetype = '*.*';    
...
$dir = "$root/PSS_Online/FromPortal2/MT7/";
