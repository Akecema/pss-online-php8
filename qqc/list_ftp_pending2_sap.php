...
/**
 * qqc/list_ftp_pending2_sap.php
 * Part of: QQC module (Quality)
 * Filename suggests: list ftp pending2 sap
 *
         ...
         <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              <li class="active"><a  role="tab" href="list_ftp_pending2_sap.php">Rework OK</a></li>
...
$path = "../../PSS_Online/FromPortal2/MT5/"; 

// Open the folder
 $dir_handle = @opendir($root . $path) or die("Unable to open $path");

$dir = "$root/FromPortal2/MT5/";

$folder = '../../PSS_Online/FromPortal2/MT5/';
$filetype = '*.*';    
...
$dir = "$root/PSS_Online/FromPortal2/MT5/";
