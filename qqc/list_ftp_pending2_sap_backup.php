...
/**
 * qqc/list_ftp_pending2_sap_backup.php
 * Part of: QQC module (Quality)
 * Filename suggests: list ftp pending2 sap backup
 *
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index_qqc.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="#">QA/QC</a> <a href="#" class="current">Backflush FTP Monitor</a></div>
...
$path = "../../PSS_Online/FromPortal2/"; 

// Open the folder
 $dir_handle = @opendir($root . $path) or die("Unable to open $path");

$dir = "$root/FromPortal2/";

$folder = '../../PSS_Online/FromPortal2/';
$filetype = '*.*';    
...
if(is_dir($dir)){
  ...
  <tr>
    <td width="43%">File Name</td>
    <td width="57%">Date Modified</td>
  </tr>
</table>
