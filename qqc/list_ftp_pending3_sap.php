...
if(is_dir($dir)){
  ...
  <?php
	...
	while($row_rs = mysql_fetch_array($rs)) {   //how many material are there?
	...
	$rs_disposal = mysql_query($query_disposal);   //run the query.
	$row_disposal = mysql_fetch_array($rs_disposal);   //how many material are there?	
