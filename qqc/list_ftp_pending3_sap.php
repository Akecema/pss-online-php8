...
/**
 * qqc/list_ftp_pending3_sap.php
 * Part of: QQC module (Quality)
 * Filename suggests: list ftp pending3 sap
 *
 * Behavior: requires an active login session ($_SESSION['username']).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, ftp_approval_qc, table_material, reject_detail_disposal.
         ...
         <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li class="active"><a role="tab" href="list_ftp_pending3_sap.php">Disposal</a></li>
...
if(is_dir($dir)){
  ...
  <table class="table">
   <tr>
    ...
    <td width="15%">Disposal Doc. No.</td>
    <td width="15%">Material No.</td>
  ...
  <?php
   ...
   <tr>
    ...
    <td width="10%"><?php echo h($row_disposal["ploc_prod_reject"]); ?></td>
