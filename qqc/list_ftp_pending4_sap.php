...
if(is_dir($dir)){
  ...
  <table class="table">
   ...
   <?php
	...
	$rs_qc = mysql_query($query_qc);   //run the query.
	$row_rs_qc = mysql_fetch_array($rs_qc);   //how many material are there?
	
	//---check material type in table material--------
		
	$query_mat_type_qc = "SELECT * FROM table_material WHERE material_no = '".$row_rs_qc["material_no"]."'";
	$rs_mat_type_qc = mysql_query($query_mat_type_qc);   //run the query.
	$row_mat_type_qc = mysql_fetch_array($rs_mat_type_qc);   //how many material are there?	
