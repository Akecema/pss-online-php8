...
/**
 * qqc/list_ftp_pending5_sap.php
 * Part of: QQC module (Quality)
 * Filename suggests: list ftp pending5 sap
 *
 * Behavior: requires an active login session ($_SESSION['username']).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, ftp_approval_qc, table_material.
         ...
         <div class="widget-box">
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li><a role="tab" href="list_ftp_pending4_sap.php">Production Output</a></li>
              <li class="active"><a role="tab" href="list_ftp_pending5_sap.php">Good Issue</a></li>
             </ul>
          </div>
          </div>
...
$path = "../../PSS_Online/FromPortal2/GI/"; 
...
$folder = '../../PSS_Online/FromPortal2/GI/';
$filetype = '*.*';    
...
$dir = "$root/PSS_Online/FromPortal2/GI/";
...
if(is_dir($dir)){
  ...
  <table class="table">
   ...
   <?php
	...
	$query = "SELECT *,DATE_FORMAT(date_create,'%d-%m-%Y %H:%i:%s') AS R2 FROM ftp_approval_qc WHERE status_ftp = 'Y' AND file_name = ? AND status_part = 'WS'"; $query_args = [$filename2];
  ...
  <tr>
    ...
    <td width="20%"><?php echo h($row_rs["doc_disposal_no"]); ?></td>
