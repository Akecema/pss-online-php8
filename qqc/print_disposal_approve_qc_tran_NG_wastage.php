...
/**
 * qqc/print_disposal_approve_qc_tran_NG_wastage.php
 * Part of: QQC module (Quality)
 * Filename suggests: print disposal approve qc tran NG wastage
 *
...
<table width="98%" border="0" cellpadding="2">
  <tr>
   <td width="35%" valign="top"><p><img src="../set_upload/<?php echo h($filename);  ?>"width="267" height="27" hspace="2" vspace="2"/></p>
