...
<div class="container-fluid">
 ...
 <?php
	   ...
	   $query_qqc = "SELECT * FROM qqc_detail_transaction WHERE id_qqc = ?"; $query_qqc_args = [$uid];
	   ...
	   $query_qqc_cal = "SELECT * FROM qqc_transaction WHERE qqc_doc_no = ? AND bflush_no = ? AND status_QC != ?"; $query_qqc_cal_args = [$data_qqc["qqc_doc_no"], $data_qqc["bflush_no"], $rst_sta4["status_desc"]];
	   $result_qqc_cal = db_query_bind($dbc, $query_qqc_cal, $query_qqc_cal_args);
...
$query_data2 = "INSERT INTO qqc_transaction (id_qqc, id_tran, qqc_doc_no, qqc_no, bflush_no, plan_no, material_no, material_desc, material_type, qty_plan, qty_actual, qty_balance, qty_NG, qty_qc, qty_qc_ok, qty_qc_NG, status_QC, comp_code, work_center, shift_day, date_plan, user_create, date_create, user_update, date_update, user_qc_posting, date_qc_posting, time_qc_posting, ploc_qc, ploc, delivery_loc, type_qc_reject, reason_qc_reject, user_qc_reject, date_qc_reject, time_qc_reject, status_ftp_fgtran, status, qqc_no_ref, user_cancel, date_cancel) VALUES('',?,?,?,?,?,?, ?,?,?,?,?,'',?,?,'',?,?, ?, ?,?,?,NOW(),'','',?,?,?,?,?,?,'','','','','','N','Y','','','')"; $query_data2_args = [$data_qqc["id_tran"], $data_qqc["qqc_doc_no"], $ref, $data_qqc["bflush_no"], $data_qqc["plan_no"], $data_qqc["material_no"], $data_qqc["material_desc"], $data_qqc["material_type"], $data_qqc["qty_plan"], $data_qqc["qty_actual"], $data_qqc["qty_balance"], $data_qqc["qty_qc"], $_POST["qty_qc_ok"], $rst_sta8["status_desc"], $data_qqc["comp_code"], $data_qqc["work_center"], $data_qqc["shift_day"], $data_qqc["date_plan"], $username, $username, $_POST["date1"], $t_time, $data_qqc["ploc_qc"], $_POST["sloc"], $ploc_qc];
$result_data2 = db_query_bind($dbc, $query_data2, $query_data2_args) or die(db_fail($dbc));
	...
	//----check qqc_transaction total pending "0" ----------	
	   ...
	   $query_qqc_cal2 = "SELECT * FROM qqc_transaction WHERE bflush_no = ? AND status_QC != ?"; $query_qqc_cal2_args = [$data_qqc["bflush_no"], $rst_sta4["status_desc"]];
	   $result_qqc_cal2 = db_query_bind($dbc, $query_qqc_cal2, $query_qqc_cal2_args);
	...
	*/
	...
	$query_upd_sta = "UPDATE qqc_detail_transaction SET status_QC = ? WHERE bflush_no = ?"; $query_upd_sta_args = [$status_new, $data_qqc["bflush_no"]];
	$result_upd_sta = db_query_bind($dbc, $query_upd_sta, $query_upd_sta_args); 
...
$query_data2 = "INSERT INTO qqc_transaction (id_qqc, id_tran, qqc_doc_no, qqc_no, bflush_no, plan_no, material_no, material_desc, material_type, qty_plan, qty_actual, qty_balance, qty_NG, qty_qc, qty_qc_ok, qty_qc_NG, status_QC, comp_code, work_center, shift_day, date_plan, user_create, date_create, user_update, date_update, user_qc_posting, date_qc_posting, time_qc_posting, ploc_qc, ploc, delivery_loc, type_qc_reject, reason_qc_reject, user_qc_reject, date_qc_reject, time_qc_reject, status_ftp_fgtran, status, qqc_no_ref, user_cancel, date_cancel) VALUES('',?,?,?,?,?,?, ?,?,?,?,?,'',?,'',?,?,?, ?, ?,?,?,NOW(),'','',?,?,?,?,?,'',?,?,?,NOW(),NOW(),'N','N','','','')"; $query_data2_args = [$data_qqc["id_tran"], $data_qqc["qqc_doc_no"], $ref, $data_qqc["bflush_no"], $data_qqc["plan_no"], $data_qqc["material_no"], $data_qqc["material_desc"], $data_qqc["material_type"], $data_qqc["qty_plan"], $data_qqc["qty_actual"], $data_qqc["qty_balance"], $data_qqc["qty_qc"], $_POST["qty_qc_NG"], $rst_sta8["status_desc"], $data_qqc["comp_code"], $data_qqc["work_center"], $data_qqc["shift_day"], $data_qqc["date_plan"], $username, $username, $_POST["date2"], $t_time2, $ploc_qc, $data_qqc["ploc"], $type_reject, $reason_reject, $username];
$result_data2 = db_query_bind($dbc, $query_data2, $query_data2_args) or die(db_fail($dbc));
	 ...
	 ?>
      ...
      for($j = 0; $j <= 59; $j++): ?>
                   ...
                   <tr>
                     <td>OK</td>
                     <td>:</td>
                     <td><input name="qty_qc_ok" type="number" min="0" max="<?php echo h($total_qty_pending); ?>" value="<?php if(isset($_POST["qty_qc_ok"])) { echo h($_POST["qty_qc_ok"]); } ?>" /></td>
                     <td colspan="4"></td>
                     </tr>
                   <tr>
	 ...
	 ?>
      ...
      for($w = 0; $w <= 59; $w++): ?>
                   ...
                   <tr>
                     <td>NG</td>
                     <td>:</td>
                     <td><input name="qty_qc_NG" type="number" min="0" max="<?php echo h($total_qty_pending); ?>" value="<?php if(isset($_POST["qty_qc_NG"])) { echo h($_POST["qty_qc_NG"]); } ?>" /></td>
                     <td colspan="4">&nbsp;</td>
                   </tr>
                   <tr>
