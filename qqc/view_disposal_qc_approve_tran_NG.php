...
/**
 * qqc/view_disposal_qc_approve_tran_NG.php
 * Part of: QQC module (Quality)
 * Filename suggests: view disposal qc approve tran NG
 *
...
<table width="98%" border="0" cellpadding="2"> 
  <tr>
    <td valign="top"><img src="../set_upload/<?php echo h($filename);  ?>" width="267" height="27" hspace="2" vspace="2"/>
               ...
               <tr>
                 ...
                 <td width="56%"><table width="82%" class="table table-bordered">
                   <tr>
                     ...
                     <td width="27%" align="left">Approved by</td>
                   </tr>
                    <tr>
