...
/**
 * qqc_super/approval_disposal_approve_tran_NG_wastage.php
 * Part of: QQC module (supervisor/admin tier)
 * Filename suggests: approval disposal approve tran NG wastage
 *
...
//------------update remarks reject detail disposal-------------------
 ...
 $result_upd3 = db_query_bind($dbc, $query_upd3, $query_upd3_args); 
  ...
  // //----------------------update table wastage_disposal
	  $query_wastage_update = "UPDATE wastage_transaction SET user_update = ?, date_update = NOW(), remark_approve2 = ?, approve_by2 = ?, date_approve2 = NOW(), status_disposal = ? WHERE id_wastage_tran = ?"; $query_wastage_update_args = [$username, $row_all["remark_approve2"], $username, $rst_sta17["status_desc"], $row_all["uid"]];
...
/*  $data .= $row_1['doc_disposal_no'].";".$row_1['id_disposal']."\r\n";*/
   ...
   $data .= $row_1['material_type'].";".$row_1['model_code'].";".$row_1['material_no'].";551;".";".$row_fac['id_factory'].";".$row_1['work_center'].";".$row_1['ploc_prod_reject'].";".$row_type['wastage_desc'].";".$row_reason['reason_wastage_desc'].";".$row_1['qty_wastage'].";".$row_1['UOM_unit'].";".$res['user_fullname'].";".$row_1['M'].";".$row_1['M2'].";".$row_1['cost_center'].";".$row_1['doc_disposal_no']."\r\n";
...
<p align="center" class="style4">&nbsp;</p>
      ...
      <!-- Content -->
              ...
              <!-- End Box Head -->
          <form name="myform" action="approval_disposal_approve_tran_NG_wastage.php?doc_disposal=<?php echo h($doc_disposal); ?>" method="post" >
            <!-- Form -->
            <div class="form">
