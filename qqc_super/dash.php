...
$query_disposal_req = "SELECT COUNT(DISTINCT doc_disposal_no) AS cnt FROM reject_detail_disposal WHERE status_disposal = ? AND (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != ''"; $query_disposal_req_args = [$rst_sta3["status_desc"]];
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
       <ul class="quick-actions">
        <li class="bg_lb"> <a href="document_list_qc_tran.php"> <i class="icon-exchange"></i> <span class="label label-important"><?php echo h($num_in_progress);   ?></span> In Progress<br> &nbsp;&nbsp;</a> </li>
        <li class="bg_ly"> <a href="disposal_production_tran_NG.php"> <i class="icon-bar-chart"></i><span class="label label-important"><?php echo h($num_disposal_req);   ?></span>Pending <br> Production Disposal</a> </li>
       <!-- <li class="bg_lv"> <a href="document_list_qc_tran.php"> <i class="icon-th"></i><span class="label label-important"><?php //echo $num_plan_req;   ?></span> Released Planned Order</a> </li>-->
        <li class="bg_ls"> <a href="disposal_qc_tran_NG.php"> <i class="icon-check"></i><span class="label label-important"><?php echo h($num_con_req);  ?></span> Pending&nbsp;&nbsp; <br>QC Disposal &nbsp;&nbsp;</a> </li>
	...
	$percent_close = number_format($percent_close, 2);
        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <ul class="unstyled">
              <li> <span class="icon24 icomoon-icon-arrow-up-2 green"></span>Pending <span class="pull-right strong"><?php echo h($num_mat_prog_open);   ?></span>
                <div class="progress progress-striped ">
                  <div style="width: <?php  echo  h($percent_open);  ?>%;" class="bar"></div>
                </div>
              </li>
              <li> <span class="icon24 icomoon-icon-arrow-up-2 green"></span>QC OK <span class="pull-right strong"><?php echo h($num_mat_prog_close);   ?></span>
