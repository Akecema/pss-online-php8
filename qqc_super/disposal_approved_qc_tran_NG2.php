...
<?php
   ...
   $query8 = "SELECT * FROM reject_detail_disposal AS MR WHERE (MR.status_part = 'QC' OR MR.status_part = 'WQ') AND MR.doc_disposal_no != '' AND MR.status_disposal != '".$rst_sta["status_desc"]."' AND MR.status_disposal != '".$rst_sta16["status_desc"]."' ".$where_sql."GROUP BY MR.doc_disposal_no";
...
$query = "SELECT *, DATE_FORMAT(MR.date_plan,'%d-%m-%Y') as R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') as R2 FROM reject_detail_disposal AS MR WHERE (MR.status_part = 'QC' OR MR.status_part = 'WQ') AND MR.doc_disposal_no != '' AND MR.status_disposal != '".$rst_sta["status_desc"]."' AND MR.status_disposal != '".$rst_sta16["status_desc"]."' ".$where_sql." GROUP BY MR.doc_disposal_no ORDER BY MR.plan_no ASC $pages->limit";
			   ...
			   <?php  }
                ...
                <td width="94"> <?php
                 if($row["status_part"] == "QC")
				   {
					?>
				 <a value="Print" href="print_disposal_approve_qc_tran_NG.php?doc_disposal=<?php echo $row["doc_disposal_no"]; ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/print2.jpg" width="16" height="16" alt="Print">Print</a>	
				<?php 
				    }elseif($row["status_part"] == "WQ")
				   {
