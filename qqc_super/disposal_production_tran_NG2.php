...
/**
 * qqc_super/disposal_production_tran_NG2.php
 * Part of: QQC module (supervisor/admin tier)
 * Filename suggests: disposal production tran NG2
 *
...
<?php
   ...
   $query8 = "SELECT * FROM reject_detail_disposal AS MR WHERE (MR.status_part = 'PR' OR MR.status_part = 'WS') AND doc_disposal_no != '' AND status_disposal = ?".$where_sql." GROUP BY MR.doc_disposal_no ORDER BY MR.plan_no ASC"; $query8_args = [$rst_sta3["status_desc"], ...$where_args];
...
$query = "SELECT *, DATE_FORMAT(MR.date_plan,'%d-%m-%Y') as R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') as R2 FROM reject_detail_disposal AS MR WHERE (MR.status_part = 'PR' OR MR.status_part = 'WS') AND doc_disposal_no != '' AND status_disposal = ?".$where_sql." GROUP BY MR.doc_disposal_no ORDER BY MR.plan_no ASC $pages->limit"; $query_args = [$rst_sta3["status_desc"], ...$where_args];
