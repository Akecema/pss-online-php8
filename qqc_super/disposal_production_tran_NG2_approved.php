...
<?php
   ...
   $query8 = "SELECT * FROM reject_detail_disposal AS MR WHERE (MR.status_part = 'PR' OR MR.status_part = 'WS') AND doc_disposal_no != '' AND status_disposal = ?".$where_sql." GROUP BY MR.doc_disposal_no ORDER BY MR.plan_no ASC"; $query8_args = [$rst_sta17["status_desc"], ...$where_args];
