      ...
      ?>
              ...
              <?php if($row["status_disposal"] == "New")
			   ...
			   { 
			      ...
			      ?>
                <a value="Approval" href="approval_disposal_qc_new_tran_NG.php?doc_disposal=<?php echo $row["doc_disposal_no"]; ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/tick.png" width="16" height="16" alt="Approval">Approval</a>
                <?php 
					 }elseif($row["status_part"] == "WQ")
					 {
					?>	 
					 <a value="Approval" href="approval_disposal_qc_new_tran_NG_wastage.php?doc_disposal=<?php echo $row["doc_disposal_no"]; ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/tick.png" width="16" height="16" alt="Approval">Approval</a>	 
				<?php	 }
