...
/**
 * qqc_super/disposal_qc_tran_NG.php
    ...
    <div class="row-fluid">
          ...
          <div class="widget-title">
             <ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
              ...
              <li><a role="tab" href="disposal_approved_qc_tran_NG.php">Approved Disposal</a></li>
             </ul>
          </div>
          </div>
      ...
      ?>
              ...
              <?php if($row["status_disposal"] == "New")
			   ...
			   { 
			      ...
			      ?>
                <a value="Approval" href="approval_disposal_qc_new_tran_NG.php?doc_disposal=<?php echo h($row["doc_disposal_no"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/tick.png" width="16" height="16" alt="Approval">Approval</a>
                <?php 
					 }elseif($row["status_part"] == "WQ")
					 {
					?>	 
					 <a value="Approval" href="approval_disposal_qc_new_tran_NG_wastage.php?doc_disposal=<?php echo h($row["doc_disposal_no"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/tick.png" width="16" height="16" alt="Approval">Approval</a>	 
				<?php	 }
