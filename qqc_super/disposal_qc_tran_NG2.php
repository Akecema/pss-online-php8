...
/**
 * qqc_super/disposal_qc_tran_NG2.php
...
<?php
   ...
   $query8 = "SELECT * FROM reject_detail_disposal AS MR WHERE (MR.status_part = 'QC' OR MR.status_part = 'WQ') AND MR.doc_disposal_no != '' AND MR.status_disposal = ? ".$where_sql." GROUP BY MR.doc_disposal_no"; $query8_args = [$rst_sta["status_desc"], ...$where_args];
