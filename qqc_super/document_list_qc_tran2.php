...
/**
 * qqc_super/document_list_qc_tran2.php
 * Part of: QQC module (supervisor/admin tier)
 * Filename suggests: document list qc tran2
 *
...
<div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM qqc_detail_transaction AS MR, work_center_detail AS SR WHERE SR.id_work = MR.work_center AND MR.status_QC = ?".$where_sql; $query8_args = [$rst_sta11["status_desc"], ...$where_args];
...
$query = "SELECT *, DATE_FORMAT(MR.date_plan,'%d-%m-%Y') as R, DATE_FORMAT(MR.date_qc_posting,'%d-%m-%Y') as R2, DATE_FORMAT(MR.date_create,'%d-%m-%Y') as R3 FROM qqc_detail_transaction AS MR, work_center_detail AS SR WHERE SR.id_work = MR.work_center AND MR.status_QC = ?".$where_sql." ORDER BY MR.plan_no ASC"; $query_args = [$rst_sta11["status_desc"], ...$where_args];
