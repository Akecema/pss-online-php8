...
$query_plan_req = "SELECT * FROM pps_detail WHERE status_pps = ? ORDER BY date_plan DESC"; $query_plan_req_args = [$rst_sta2["status_desc"]];
...
$query_disposal_req = "SELECT * FROM reject_detail_disposal WHERE status_disposal = ? AND (status_part = 'PR' OR status_part = 'WS') AND doc_disposal_no != '' GROUP BY doc_disposal_no ORDER BY date_plan DESC"; $query_disposal_req_args = [$rst_sta3["status_desc"]];
