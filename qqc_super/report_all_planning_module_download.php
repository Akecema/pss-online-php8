...
$namaFile = "Report Planned Order_".$date_tdy.".xls";
 //convert material no kpd id_hdr
  ...
  $query8 = "SELECT *, DATE_FORMAT(date_plan,'%d-%m-%Y') as R, DATE_FORMAT(date_posting,'%d-%m-%Y') as R2 FROM pps_detail WHERE (status_pps != '".db_esc($dbc, $rst_sta2["status_desc"])."' AND status_pps != '".db_esc($dbc, $rst_sta4["status_desc"])."' AND status_pps != '".db_esc($dbc, $rst_sta16["status_desc"])."') ORDER BY plan_no ASC";
...
$query = "SELECT *, DATE_FORMAT(date_plan,'%d-%m-%Y') as R, DATE_FORMAT(date_posting,'%d-%m-%Y') as R2, DATE_FORMAT(date_posting,'%H:%i:%s') as T2 FROM pps_detail WHERE (status_pps != '".db_esc($dbc, $rst_sta2["status_desc"])."' AND status_pps != '".db_esc($dbc, $rst_sta4["status_desc"])."' AND status_pps != '".db_esc($dbc, $rst_sta16["status_desc"])."') ORDER BY plan_no ASC";
