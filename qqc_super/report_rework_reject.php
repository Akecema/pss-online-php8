...
/**
 * qqc_super/report_rework_reject.php
...
<?php
   ...
   $query8 = "SELECT COUNT(*) FROM reject_detail_disposal WHERE status_part = 'QC' AND qty_qc_NG != ''";
...
$query = "SELECT *,DATE_FORMAT(date_reject,'%d-%m-%Y %H:%i:%s') as R FROM reject_detail_disposal WHERE status_part = 'QC' AND qty_qc_NG != '' ORDER BY plan_no ASC";
