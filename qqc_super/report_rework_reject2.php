...
/**
 * qqc_super/report_rework_reject2.php
 * Part of: QQC module (supervisor/admin tier)
 * Filename suggests: report rework reject2
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, request_status, factory_detail, work_center_detail, reject_detail_disposal, type_reject_detail, reason_ng_reject, mat_master_header, pps_detail.
...
<div id="content-header">
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT COUNT(*) FROM reject_detail_disposal AS MR, work_center_detail AS SR WHERE SR.id_work = MR.work_center AND MR.status_part = 'QC' AND MR.qty_qc_NG != ''".$where_sql; $query8_args = [...$where_args];
...
$query = "SELECT *,DATE_FORMAT(MR.date_reject,'%d-%m-%Y %H:%i:%s') as R FROM reject_detail_disposal AS MR, work_center_detail AS SR WHERE SR.id_work = MR.work_center AND MR.status_part = 'QC' AND MR.qty_qc_NG != ''".$where_sql." ORDER BY MR.plan_no ASC"; $query_args = [...$where_args];
...
<tr>
    ...
    <td width="85%"> <div class="small-nav"></div></td> 
      <td width="7%"><a href="report_rework_reject_download.php?date1=<?php echo h($dateF); ?>&&date2=<?php echo h($dateT); ?>&&factory=<?php echo h($factory); ?>&&work_center=<?php echo h($work_center); ?>" ><img src="../img/dload_excel.jpg" width="48" height="48" title="Download" /></a></td>
