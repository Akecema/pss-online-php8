...
/**
 * qqc_super/report_wastage_reject.php
...
<?php
        if(isset($_POST["Submit2"]))
        {
            $dateF = $_POST["date1"];
			$dateT = $_POST["date2"];
           	$disposal_doc = $_POST["disposal_doc"];
			$disposal_doc2 = $_POST["disposal_doc2"];
											
            echo "<script>";
			echo "window.location='report_wastage_reject2.php?date1=$dateF&&date2=$dateT&&disposal_doc=$disposal_doc&&disposal_doc2=$disposal_doc2'";
            echo "</script>";
            exit(); //quit the script
        }
        
								 
   $query8 = "SELECT COUNT(*) FROM reject_detail_disposal WHERE status_part = 'WQ' AND qty_wastage != '' AND doc_disposal_no != ''";
...
$query = "SELECT *, DATE_FORMAT(date_posting,'%d-%m-%Y') as R FROM reject_detail_disposal WHERE status_part = 'WQ' AND qty_wastage != '' AND doc_disposal_no != '' ORDER BY doc_disposal_no ASC";
