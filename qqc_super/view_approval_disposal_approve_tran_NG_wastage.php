...
/**
 * qqc_super/view_approval_disposal_approve_tran_NG_wastage.php
 * Part of: QQC module (supervisor/admin tier)
 * Filename suggests: view approval disposal approve tran NG wastage
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: user_detail, sys_setup_maintain, reject_detail_disposal, type_wastage_detail, reason_wastage, mat_master_header, pps_detail.
...
<tr>
               ...
               <input name="id_disposal[<?php echo h($row["id_disposal"]); ?>]" type="hidden" value="<?php echo h($row["id_disposal"]); ?>"></td>
                <td width="250"><?php echo h($row["remark_approve2"]); ?></td>
      </tr>
    </tbody>        
                 ...
                 <td width="56%"><table width="100%" class="table table-bordered">
                   <tr>
                    ...
                    <tr>
                     ...
                     <br><?php echo h($row_disposal["W2"]);   ?></p>
                     </td>
                     <td>&nbsp;</td>
                     <td><p><b><?php echo h($res_approve["user_fullname"]);   ?></b>
                     <br><?php if(($res_approve["user_fullname"]) != "") {  echo h($row_disposal["W3"]); }  ?></p></td>
                     <td><p><b><?php echo h($res_approve2["user_fullname"]);   ?></b>
                      <br><?php if(($res_approve2["user_fullname"]) != "") { echo h($row_disposal["W4"]); }  ?></p></td>
                   </tr>
                   <tr>
