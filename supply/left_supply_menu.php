<?php
/**
 * supply/left_supply_menu.php
 * Part of: Supply Chain module
 * Filename suggests: left supply menu
 *
...
?>
<!--sidebar-menu-->
<div id="sidebar"><a href="index_supply.php" class="visible-phone"><i class="icon icon-home"></i> Home</a>
  <ul>
    <?php if ($url == "index_supply.php"){ ?>
    <li class="active"><?php }else { echo "<li>"; } ?><a href="index_supply.php"><i class="icon icon-home"></i> <span>Home</span></a> </li>  
