...
/**
 * supply_super/ST_manual_uploadProc.php
...
<div id="content">
 <div id="content-header" class="noprint">
  <div id="breadcrumb"> <a href="index_supply_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">Uploaded MIGO TR </a><a href="#" class="current">Uploaded ST</a></div>
...
<?php
   ...
   <tr>
    <td width="99">&nbsp;<font color="#003399"><?php echo h($row2["mrin_no"]); ?></font></td>
    <td width="151">&nbsp;<?php echo h($row2["material_no"]); ?></td>
    <td width="91"><div align="center"><?php echo h($row2["mat_doc"]); ?></div></td>
