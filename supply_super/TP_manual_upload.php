...
/**
 * supply_super/TP_manual_upload.php
 * Part of: Supply Chain module (supervisor/admin tier)
 * Filename suggests: TP manual upload
 *
...
?></td>
      ...
      <?php
        if(isset($_POST["Submit"]))
        {
            ...
            echo "<script>";
echo "window.location='TP_manual_uploadProc.php?date1=$dateF&&date2=$dateT&&material_no=$material_no'";
            echo "</script>";
