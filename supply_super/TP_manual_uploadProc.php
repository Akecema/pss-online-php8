...
/**
 * supply_super/TP_manual_uploadProc.php
 * Part of: Supply Chain module (supervisor/admin tier)
 * Filename suggests: TP manual uploadProc
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, sys_setup_maintain, mat_master_detail, mat_master_header, ftp_detail.
...
<div id="content">
 <div id="content-header" class="noprint">
  <div id="breadcrumb"> <a href="index_supply_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="#" class="tip-bottom">Uploaded MIGO TR </a><a href="#" class="current">Uploaded TP</a></div>
  ...
  <div class="container-fluid">
   ...
   $query8 = "SELECT *,DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R FROM ftp_detail AS MR WHERE MR.mrin_no != '' " .$where_sql; $query8_args = [...$where_args];
...
$query = "SELECT *,DATE_FORMAT(MR.transfer_date,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM ftp_detail AS MR WHERE  MR.mrin_no != '' ".$where_sql; $query_args = [...$where_args];
...
<?php
  ...
  <tr>
    ...
    <td width="118"><?php echo h($row2["prod_order"]); ?></td>
