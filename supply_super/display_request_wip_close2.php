...
?>
  ...
  <tr>
    ...
    <td width="50"><a href="detail_wip_request_printing.php?mrin_no=<?php echo $row2["temp_mrin_wip"]; ?>&&prod_order=<?php echo $row2["prod_order"]; ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>  
  <?php 
