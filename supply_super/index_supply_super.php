...
/**
 * supply_super/index_supply_super.php
 * Part of: Supply Chain module (supervisor/admin tier)
 * Filename suggests: index supply super
 *
 * Behavior: requires an active login session ($_SESSION['username']).
 * Database tables referenced: user_detail, sys_setup_maintain, login_detail, wip_request.
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index_supply_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
<!--End-breadcrumbs-->
<?php 
