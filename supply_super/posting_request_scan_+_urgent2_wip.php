  ...
  <!--  <div class="span6">-->
		 ...
		 // 3. Temp MRIN
                if ($temp_mrin == "" ){
                    ...
                    $wheresql_03 = " AND MR.temp_mrin_wip = '".db_esc($dbc, $temp_mrin)."'"; }          
   ...
   $query8 = "SELECT *, DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM wip_request AS MR, scan_detail_wip AS SD WHERE MR.id_scan_wip = SD.id_scan AND MR.status_request = 'Y' AND MR.status != 'Cancel' AND MR.status != 'Close'".$where_sql." GROUP BY MR.temp_mrin_wip ORDER BY MR.id_req_wip ASC";
