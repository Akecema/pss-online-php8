...
/**
 * supply_super/posting_request_scan_+_urgent2_wip.php
 * Part of: Supply Chain module (supervisor/admin tier)
 * Filename suggests: posting request scan + urgent2 wip
 *
 * Behavior: requires an active login session ($_SESSION['username']); reads parameters from the query string ($_GET).
 * Database tables referenced: user_detail, sys_setup_maintain, factory_detail, work_center_detail, wip_request, scan_detail_wip, wip_request_close, wip_request_cancel.
 * Includes: config.php, paginator.class2.php, tc_calendar.php, top_modal_menu.php, left_supply_super_menu.php, footer.php.
 *
...
<!--sidebar-menu-->
<?php include "left_supply_super_menu.php";  ?>
<!--sidebar-menu-->

<div id="content">
<div id="content-header">
  <div id="breadcrumb"> <a href="index_supply_super.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Material Request</a> <a href="#" class="current">Display Material Request</a> </div>
  ...
  <!--  <div class="span6">-->
		 ...
		 // 3. Temp MRIN
                if ($temp_mrin == "" ){
                    ...
                    $wheresql_03 = " AND MR.temp_mrin_wip = ?"; $wheresql_03_args = [$temp_mrin]; }          
...
$query = "SELECT *, DATE_FORMAT(MR.date_mrin,'%d-%m-%Y') AS R, DATE_FORMAT(MR.date_posting,'%d-%m-%Y') AS R2 FROM wip_request AS MR, scan_detail_wip AS SD WHERE MR.id_scan_wip = SD.id_scan AND MR.status_request = 'Y' AND MR.status != 'Cancel' AND MR.status != 'Close'".$where_sql." GROUP BY MR.temp_mrin_wip ORDER BY MR.date_posting ASC, MR.temp_mrin_wip ASC "; $query_args = [...$where_args];
...
?>
      ...
      <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Display Material Request</h5>
          </div>
         ...
         <!-- <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px #d5d5d5;">
              <tr>
                <th width="139" height="28" bgcolor="#E9F58D"><span class="style3">MRIN No.</span></th>
                <th width="75" height="28" bgcolor="#E9F58D"><span class="style3">Factory</span></th>
                <th width="74" height="28" bgcolor="#E9F58D"><span class="style3">Line</span></th>
                <th width="106" height="28" bgcolor="#E9F58D"><span class="style3">Request Date</span></th>
                <th width="69" bgcolor="#E9F58D"><span class="style3">Request Time</span></th>
                <th width="120" height="28" bgcolor="#E9F58D" class="ac style3">Requestor</th>
                <th width="53" bgcolor="#E9F58D" class="ac style3">Status</th>
                <th width="53" bgcolor="#E9F58D" class="ac style3">View</th>
                <th width="57" bgcolor="#E9F58D" class="ac style3">Print</th>
            </tr>
          </table>-->
   ...
   $row_scan = mysqli_fetch_array($result_scan);
	...
	$query_again = "SELECT * FROM wip_request WHERE status_request = 'Y' and id_scan_wip = ?"; $query_again_args = [$row2[6]];
	...
	//------------------------------
	    ...
	    $query_check = "SELECT * FROM wip_request_close WHERE temp_mrin_wip = ?"; $query_check_args = [$row2["temp_mrin_wip"]];
	   ...
	   $stat = '<font color="#009900"><b>Open</b></font>';
	    ...
	    $query_check2 = "SELECT * FROM wip_request_cancel WHERE temp_mrin_wip = ?"; $query_check2_args = [$row2["temp_mrin_wip"]];
  ...
  <tr>
    <td width="130">&nbsp;<?php echo h($row2["temp_mrin_wip"]); ?></td>
    <td width="80"><?php echo h($row_scan["factory"]); ?></td>
     <td width="65" ><?php echo h($row_scan["work_center"]); ?></td>
                <td width="100"><?php echo h($row2["R"]); ?>&nbsp;</td>
                <td width="70"><?php echo h($row2["time_mrin"]); ?></td>
                <td width="100"><?php echo h($data_u["user_fullname"]); ?>&nbsp;</td>
     
                <td width="50">&nbsp;<?php echo $stat; ?></td>
              <td width="50"><a value="Details" href="detail_wip_request.php?mrin_no=<?php echo h($row2["temp_mrin_wip"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/icon_view.jpg" width="16" height="16" alt="View">View</a></td>
                <td width="50"><a href="detail_wip_request_printing.php?mrin_no=<?php echo h($row2["temp_mrin_wip"]); ?>&&TB_iframe=true&height=400&width=1000" class="thickbox" target="_self"><img src="../img/print.jpg" width="16" height="16" alt="Print">Print</a> </td>
  </tr>
