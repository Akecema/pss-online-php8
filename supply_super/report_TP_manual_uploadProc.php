...
/**
 * supply_super/report_TP_manual_uploadProc.php
 * Part of: Supply Chain module (supervisor/admin tier)
 * Filename suggests: report TP manual uploadProc
 *
 * Behavior: requires an active login session ($_SESSION['username']); processes submitted form data ($_POST).
 * Database tables referenced: sys_setup_maintain, mat_master_header, ftp_detail.
 * Includes: config.php.
 *
...
$namaFile = "TP Manual Upload Report.xls";
 ...
 while ($row2 = mysqli_fetch_array($rs))
   {
	...
	echo '<td>'. strtoupper($row2["prod_order"]).'</td>';
